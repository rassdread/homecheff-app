...
const LEGACY_SPECIALIZATION_TO_TAXONOMY_ID: Record<string, string> = {
  ...
  studio_session: 'artistic.studio_session',
  studiosessie: 'artistic.studio_session',
  music_production: 'artistic.music_production',
  mixing_mastering: 'artistic.mixing_mastering',
  songwriting: 'artistic.songwriting',
  dj: 'artistic.dj',
  podcast: 'artistic.podcast',
  voiceover: 'artistic.voiceover',
  rehearsal_space: 'artistic.rehearsal_space',
  ...
  household: 'practical.household',
  tidying: 'practical.tidying',
  laundry: 'practical.laundry',
  errands: 'practical.errands',
