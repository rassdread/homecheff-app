...
export function buildCurrentBaselineView(
  ...
  return {
    ...
    employmentExtrasCents: facts?.employmentExtrasCents ?? null,
    employmentExtrasStatus: facts?.employmentExtrasStatus ?? null,
    thirteenthMonthCents: facts?.thirteenthMonthCents ?? null,
    bonusCommissionCents: facts?.bonusCommissionCents ?? null,
    overtimeOtherPayCents: facts?.overtimeOtherPayCents ?? null,
    companyCarTaxableAnnualCents: facts?.companyCarTaxableAnnualCents ?? null,
    companyCarTaxableMonthlyCents: facts?.companyCarTaxableMonthlyCents ?? null,
    companyCarStatus: facts?.companyCarStatus ?? null,
    companyCarResolution: facts?.companyCarResolution ?? null,
    companyCarGrossAdditionCents: facts?.companyCarGrossAdditionCents ?? null,
    companyCarOwnContributionCents: facts?.companyCarOwnContributionCents ?? null,
    companyCarOwnContributionUnknown: facts?.companyCarOwnContributionUnknown ?? false,
    payrollCompanyCarAdditionCents: facts?.payrollCompanyCarAdditionCents ?? null,
    payrollCompanyCarOwnContributionCents: facts?.payrollCompanyCarOwnContributionCents ?? null,
    ...
    bankNetMonthlyCents: facts?.bankNetMonthlyCents ?? null,
    withheldPayrollTaxCents: facts?.withheldPayrollTaxCents ?? null,
    employeePensionCents: facts?.employeePensionCents ?? null,
    pensionStatus: facts?.pensionStatus ?? null,
    pensionExplicitZero: facts?.pensionExplicitZero === true,
    otherBankDeductionCents: facts?.otherBankDeductionCents ?? 0,
