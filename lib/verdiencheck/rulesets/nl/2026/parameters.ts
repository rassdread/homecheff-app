...
import { NL_2026_EFFECTIVE, SRC_AHK_2026, SRC_AK_2026, SRC_BOX1_2026, SRC_ROW, SRC_ZAKELIJKE_KOSTEN, SRC_AFSCHRIJVING, SRC_BEDRIJFSMIDDELEN, SRC_ZAKELIJK_OF_PRIVE, SRC_AFTREKBARE_KOSTEN_OVERZICHT, SRC_BEPERKT_AFTREKBARE_2026, SRC_WZT_2026, SRC_ZORGTOESLAG_2026, SRC_ZVW_2026, SRC_HUURTOESLAG_WET_2026, SRC_KGB_WET_2026, SRC_KOT_STB_2026, SRC_IACK_2026, SRC_IACK_VOORWAARDEN_2026, SRC_IACK_ALGEMEEN, SRC_AOW_HEFFINGSKORTINGEN_2026, SRC_VOORLOPIGE_AANSLAG_2026, SRC_EWF_2026, SRC_HILLEN_2026, SRC_TARIEFSAANPASSING_EW_2026, SRC_WOZ_IB_2026 } from './sources';
import {
  EWF_HIGH_BASE_CENTS,
  EWF_HIGH_THRESHOLD_CENTS,
  HILLEN_2026_DENOMINATOR,
  HILLEN_2026_NUMERATOR,
  TARIEFSAANPASSING_2026_DENOMINATOR,
  TARIEFSAANPASSING_2026_NUMERATOR,
  TARIEFSAANPASSING_THRESHOLD_CENTS,
  WOZ_VALUE_DATE,
} from './owner-occupied-home';
...
export const NL_2026_PARAMETERS: Readonly<Record<string, RuleParameter>> = {
  ...
  'row.costs.userEstimatedAllowableOnly': param(
    'NO_AUTOMATIC_ALL_COSTS_DEDUCTIBLE',
    SRC_ZAKELIJKE_KOSTEN,
    'CERTIFIED_FOR_ASSUMPTION_MODE',
  ),
  'row.costs.depreciationBoundary': param(
    'NO_FULL_INVESTMENT_DEDUCTION_IN_HELPER',
    SRC_AFSCHRIJVING,
    'CERTIFIED_FOR_ASSUMPTION_MODE',
  ),
  'row.costs.assetThreshold': param('NO_SILENT_ASSET_CLASSIFICATION', SRC_BEDRIJFSMIDDELEN, 'CERTIFIED_FOR_ASSUMPTION_MODE'),
  'row.costs.mixedPrivateBusiness': param('BUSINESS_SHARE_ONLY', SRC_ZAKELIJK_OF_PRIVE, 'CERTIFIED_FOR_ASSUMPTION_MODE'),
  'row.costs.allowableOverview': param('SITUATION_DEPENDENT_ALLOWABLE_COSTS', SRC_AFTREKBARE_KOSTEN_OVERZICHT, 'CERTIFIED_FOR_ASSUMPTION_MODE'),
  'row.costs.limitedDeductible2026': param('NO_AUTOMATIC_LIMITED_COST_FORMULA_IN_HELPER', SRC_BEPERKT_AFTREKBARE_2026, 'CERTIFIED_FOR_ASSUMPTION_MODE'),
  ...
  'ewf.wozValueDate': param(WOZ_VALUE_DATE, SRC_WOZ_IB_2026),
  'ewf.highThresholdCents': param(EWF_HIGH_THRESHOLD_CENTS, SRC_EWF_2026),
  'ewf.highBaseCents': param(EWF_HIGH_BASE_CENTS, SRC_EWF_2026),
  'hillen.rate': param({ n: BigInt(HILLEN_2026_NUMERATOR), d: BigInt(HILLEN_2026_DENOMINATOR) }, SRC_HILLEN_2026),
  'tariefsaanpassing.thresholdCents': param(TARIEFSAANPASSING_THRESHOLD_CENTS, SRC_TARIEFSAANPASSING_EW_2026),
  'tariefsaanpassing.rate': param(
    { n: BigInt(TARIEFSAANPASSING_2026_NUMERATOR), d: BigInt(TARIEFSAANPASSING_2026_DENOMINATOR) },
