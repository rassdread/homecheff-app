...

{
  ...
  assert.ok(gate.blockers.includes(PHASE_3B3_30_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ONLY));
...

{
  ...
  assert.ok(bad.blockers.includes(PHASE_3B3_30_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ONLY));
...

{
  ...
  assert.equal(
    ...
    "3B.3.31-controlled-workspace-host-activation",
  );
