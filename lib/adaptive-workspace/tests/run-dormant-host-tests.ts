...

{
  ...
  assert.ok(bad.blockers.includes(PHASE_3B3_40_CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_ONLY));
...

{
  ...
  assert.equal(
    ...
    "3B.3.41-controlled-workspace-host-activation",
  );
