...

{
  ...
  assert.ok(gate.blockers.includes(PHASE_3B3_35_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_ONLY));
...

{
  ...
  assert.ok(bad.blockers.includes(PHASE_3B3_35_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_ONLY));
...

{
  ...
  assert.equal(
    ...
    "3B.3.36-controlled-workspace-host-activation",
  );
