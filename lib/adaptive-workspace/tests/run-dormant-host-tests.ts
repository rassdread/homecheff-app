...

{
  ...
  assert.equal(a.nextEligibleStep, "3B.3.22");
...

{
  ...
  assert.ok(bad.blockers.includes(PHASE_3B3_21_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_ONLY));
