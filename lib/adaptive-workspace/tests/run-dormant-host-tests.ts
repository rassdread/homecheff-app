...

{
  ...
  assert.ok(gate.blockers.includes(PHASE_3B3_31_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_ONLY));
...

{
  ...
  assert.ok(bad.blockers.includes(PHASE_3B3_31_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_ONLY));
...

{
  ...
  assert.equal(
    ...
    "3B.3.32-controlled-workspace-host-activation",
  );
