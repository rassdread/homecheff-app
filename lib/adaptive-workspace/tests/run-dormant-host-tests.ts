...

{
  ...
  assert.equal(a.nextEligibleStep, "3B.3.20");
...

{
  ...
  assert.ok(gate.blockers.includes(PHASE_3B3_19_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_DECISION_ONLY));
...

{
  ...
  assert.ok(bad.blockers.includes(PHASE_3B3_19_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_DECISION_ONLY));
