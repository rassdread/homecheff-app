...

{
  ...
  assert.equal(a.nextEligibleStep, "3B.3.23");
...

{
  ...
  assert.ok(bad.blockers.includes(PHASE_3B3_22_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_TRANSACTION_ONLY));
