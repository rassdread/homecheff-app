...

{
  ...
  assert.ok(gate.blockers.includes(PHASE_3B3_34_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_ONLY));
...

{
  ...
  assert.ok(bad.blockers.includes(PHASE_3B3_34_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_ONLY));
...

{
  ...
  assert.equal(
    ...
    "3B.3.35-controlled-workspace-host-activation",
  );
