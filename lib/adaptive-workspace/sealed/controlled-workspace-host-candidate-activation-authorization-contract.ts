/**
 * Phase 3B.3.43 — Controlled Workspace Host Candidate Activation Authorization Contract.
 */
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_SCHEMA_VERSION =
  1 as const;

export type ControlledWorkspaceHostCandidateActivationAuthorizationContract = {
  schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_SCHEMA_VERSION;
  phase: "3B.3.43";
  ...
  contractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_ID;
  ...
  activationRestriction: typeof PHASE_3B3_43_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ONLY;
  nextEligibleStep: "3B.3.44";
};

export function createControlledWorkspaceHostCandidateActivationAuthorizationContract(): ControlledWorkspaceHostCandidateActivationAuthorizationContract {
  return validateControlledWorkspaceHostCandidateActivationAuthorizationContract({
    schemaVersion:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_SCHEMA_VERSION,
    phase: "3B.3.43",
    previousPhase: "3B.3.42",
    widgetId: "feed.discovery",
    ...
    activationTransactionCommitId:
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_ID,
    contractId: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_ID,
...
export function validateControlledWorkspaceHostCandidateActivationAuthorizationContract(
  candidate: unknown,
): ControlledWorkspaceHostCandidateActivationAuthorizationContract {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_INVALID",
      "Transaction commit contract must be a plain object",
    );
  }
  const c = candidate as ControlledWorkspaceHostCandidateActivationAuthorizationContract;
  if (
    c.phase !== "3B.3.43" ||
    c.previousPhase !== "3B.3.42" ||
    c.nextEligibleStep !== "3B.3.44"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_PHASE",
      "phase must be 3B.3.43 with previousPhase 3B.3.42",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_FLAGS",
