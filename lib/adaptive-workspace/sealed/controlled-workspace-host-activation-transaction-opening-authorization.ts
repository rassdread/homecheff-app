 ...
 * (metadata only).
 *
 * Proves the frozen Phase 3B.3.30 transaction-opening-ready state is legally authorized
 * for a future controlled issuance-transaction opening operation.
 * Does not open, prepare, commit, abort, start, or complete the issuance transaction.
 */
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_31_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_ONLY =
  "PHASE_3B3_31_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-opening-authorization.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-opening-authorization.contract.v1" as const;


export type ControlledWorkspaceHostActivationTransactionOpeningAuthorizationState =
  | "TRANSACTION_OPENING_AUTHORIZED_NOT_OPENED"
  | "BLOCKED";

export type ControlledWorkspaceHostActivationTransactionOpeningAuthorizationResult =
  | "controlled-workspace-host-activation-transaction-opening-authorized-not-opened"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-predecessor"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-readiness"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-selection"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-candidate"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-contract"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-duplicate-entry"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-boundary-executable"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-runtime-capability"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-runtime-host"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-activation-handle"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-workspace-render"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-second-geofeed"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-runtime-mutation"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-shell"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-ownership"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-renderer"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-writer"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-pipeline"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-transaction"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-armed"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-crossed"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-committed"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-aborted"
  | "controlled-workspace-host-activation-transaction-opening-authorization-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_CONDITIONS =
  Object.freeze([
    "phase-3b329-active",
    "previous-phase-3b328-complete",
    "next-eligible-step-3b330",
    "transaction-opening-authorization-result-exact",
    "transaction-opening-authorization-state-exact",
    ...
    "activation-transaction-opening-authorization-identity-exact",
    "activation-transaction-opening-authorization-contract-identity-exact",
    ...
    "exactly-one-grant",
    "exactly-one-transaction-opening-authorization",
    ...
    "transaction-opening-authorization-identity-unique",
    ...
    "transaction-opening-authorization-not-allowed-after-entry",
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_GUARDS =
  Object.freeze([
    ...
    "activation-transaction-opening-authorization-identity-exactness",
    "candidate-uniqueness",
    "grant-uniqueness",
    "commit-boundary-uniqueness",
    "transaction-opening-authorization-uniqueness",
...
export type ControlledWorkspaceHostActivationTransactionOpeningAuthorizationRecord = {
  ...
  readonly activationTransactionOpeningAuthorizationAllowed: false;
...
export type ControlledWorkspaceHostActivationTransactionOpeningAuthorizationDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_SCHEMA_VERSION;
  readonly phase: "3B.3.31";
  readonly previousPhase: "3B.3.30";
  readonly currentPhase: "3B.3.31";
  readonly nextEligibleStep: "3B.3.32";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly transactionOpeningAuthorizationState: "TRANSACTION_OPENING_AUTHORIZED_NOT_OPENED";
  readonly transactionOpeningAuthorizationResult: "controlled-workspace-host-activation-transaction-opening-authorized-not-opened";
  readonly transactionOpeningAuthorizationCompleted: true;
  ...
  readonly transactionOpeningAuthorizationCount: 1;
  ...
  readonly duplicateTransactionOpeningAuthorizationCount: 0;
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionOpeningAuthorizationRecords: readonly [ControlledWorkspaceHostActivationTransactionOpeningAuthorizationRecord];
  readonly predecessorActivationTransactionOpeningReadinessResult: "controlled-workspace-host-activation-transaction-opening-ready-not-opened";
  readonly predecessorActivationTransactionOpeningReadinessState: "TRANSACTION_OPENING_READY_NOT_OPENED";
  ...
  readonly issuanceTransactionResult: "authorization-grant-issuance-transaction-authorized-not-opened";
  ...
  readonly activationBlocker: typeof PHASE_3B3_31_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostActivationTransactionOpeningAuthorizationDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostActivationTransactionOpeningAuthorizationEvaluation = {
  readonly descriptor: ControlledWorkspaceHostActivationTransactionOpeningAuthorizationDescriptor;
  readonly diagnostics: ControlledWorkspaceHostActivationTransactionOpeningAuthorizationDiagnostics;
};

export type ControlledWorkspaceHostActivationTransactionOpeningAuthorizationInput = {
  readonly entry?: Partial<ControlledWorkspaceHostActivationTransactionOpeningAuthorizationRecord> &
...
function createTransactionOpeningAuthorizationRecord(): ControlledWorkspaceHostActivationTransactionOpeningAuthorizationRecord {
...
function blockedResultFor(
  input: ControlledWorkspaceHostActivationTransactionOpeningAuthorizationInput | undefined,
): ControlledWorkspaceHostActivationTransactionOpeningAuthorizationResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-candidate";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-pipeline";
  }
  ...
  if (input.transactionOpeningReady === false) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-missing-readiness";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-illegal-transition";
  }
  ...
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-second-geofeed";
    }
    if (
      ...
      r.activationTransactionOpeningAuthorizationAllowed === true ||
      r.activationExecutionAllowed === true
    ) {
      return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-opening-authorization-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostActivationTransactionOpeningAuthorizationDescriptor(): ControlledWorkspaceHostActivationTransactionOpeningAuthorizationDescriptor {
  const record = createTransactionOpeningAuthorizationRecord();
  return validateControlledWorkspaceHostActivationTransactionOpeningAuthorizationDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_SCHEMA_VERSION,
      phase: "3B.3.31",
      previousPhase: "3B.3.30",
      ...
      certificatePresent: false,
      permitPresent: false,
      transactionOpeningAuthorizationRecords: [record],
      ...
      issuanceTransactionResult:
        "authorization-grant-issuance-transaction-authorized-not-opened",
      ...
      activationBlocker:
        PHASE_3B3_31_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostActivationTransactionOpeningAuthorizationDescriptor(
  d: ControlledWorkspaceHostActivationTransactionOpeningAuthorizationDescriptor,
): ControlledWorkspaceHostActivationTransactionOpeningAuthorizationDescriptor {
  if (
    d.phase !== "3B.3.31" ||
    d.previousPhase !== "3B.3.30" ||
    d.currentPhase !== "3B.3.31" ||
    d.nextEligibleStep !== "3B.3.32"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_PHASE",
      "Phase chain must be 3B.3.30 → 3B.3.31 → 3B.3.32",
    );
  }
  if (
    d.transactionOpeningAuthorizationState !== "TRANSACTION_OPENING_AUTHORIZED_NOT_OPENED" ||
    d.transactionOpeningAuthorizationResult !==
      "controlled-workspace-host-activation-transaction-opening-authorized-not-opened"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_RESULT",
      "Successful readiness must be TRANSACTION_OPENING_AUTHORIZED_NOT_OPENED",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_IDENTITY",
  ...
  if (
    ...
    d.transactionOpeningStarted !== false ||
    d.transactionOpeningCompleted !== false
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_FLAGS",
      "Authorization requires ready=true, authorized=true, started=false, completed=false",
    );
  }
  if (
    d.candidateCount !== 1 ||
    ...
    d.grantCount !== 1 ||
    d.transactionOpeningAuthorizationCount !== 1 ||
    d.duplicateTransactionOpeningAuthorizationCount !== 0 ||
    d.candidateGranted !== true ||
    d.candidateActivated !== false ||
    d.grantExecutable !== false ||
    d.activationCommitBoundaryExecutable !== false ||
    d.activationTransactionOpeningAuthorizationAllowed !== false ||
    d.activationExecutionAllowed !== false
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_TRANSITION",
      "Only the legal NOT_ENTERED → ENTERED transition may be recorded",
    );
  }
  if (
    d.predecessorActivationTransactionOpeningReadinessState !== "TRANSACTION_OPENING_READY_NOT_OPENED" ||
    d.predecessorActivationTransactionOpeningReadinessResult !==
      "controlled-workspace-host-activation-transaction-opening-ready-not-opened" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_RUNTIME",
...
export function evaluateControlledWorkspaceHostActivationTransactionOpeningAuthorization(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostActivationTransactionOpeningAuthorizationInput,
): ControlledWorkspaceHostActivationTransactionOpeningAuthorizationEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_REGISTRY",
      "Transaction-opening authorization requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluateControlledWorkspaceHostActivationTransactionOpeningReadiness(registry);
  const pred = predecessor.descriptor;

  if (
    pred.transactionOpeningReadinessResult !==
      "controlled-workspace-host-activation-transaction-opening-ready-not-opened" ||
    pred.transactionOpeningReadinessState !== "TRANSACTION_OPENING_READY_NOT_OPENED" ||
    pred.transactionOpeningReady !== true ||
    pred.transactionOpeningAuthorized !== false ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_PREDECESSOR_LIVE",
      "Predecessor transaction-opening readiness must remain READY_NOT_OPENED with transaction NOT_OPENED",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_BLOCKED",
      blocked,
    );
  }
  ...
  const record = descriptor.transactionOpeningAuthorizationRecords[0];
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningAuthorizationAllowed: false,
      activationExecutionAllowed: false,
      transactionOpeningAuthorizationResult: descriptor.transactionOpeningAuthorizationResult,
      transactionOpeningAuthorizationState: descriptor.transactionOpeningAuthorizationState,
      ...
      activationTransactionOpeningAuthorizationId: record.activationTransactionOpeningAuthorizationId,
      activationTransactionOpeningAuthorizationContractId:
      ...
      guardCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_GUARDS.length,
      satisfiedGuardCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_GUARDS.length,
      unsatisfiedGuardCount: 0,
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_BLOCKERS,
      transactionOpeningAuthorizationRecords: descriptor.transactionOpeningAuthorizationRecords,
    },
  };
}
