/**
 * Phase 3B.3.17 — pure host activation gate.
 * Always returns allowed=false with PHASE_3B3_17_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_DECISION_ONLY.
 */
...
export function evaluateFeedHostActivationGate(
  ...
  const reasons: string[] = [
    "Phase 3B.3.17 models sealed activation transition authorization decision only; hostActivation remains deferred to 3B.3.18",
  ];
