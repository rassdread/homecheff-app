/**
 * Phase 3B.3.30 — pure host activation gate.
 * Always returns allowed=false with PHASE_3B3_30_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ONLY.
 */
...
export function evaluateFeedHostActivationGate(
  ...
  const reasons: string[] = [
    "Phase 3B.3.30 proves Adaptive Workspace Host Activation transaction-opening readiness only; the issuance transaction remains NOT_OPENED and deferred to 3B.3.31+",
  ];
