/**
 * Phase 3B.3.31 — pure host activation gate.
 * Always returns allowed=false with PHASE_3B3_31_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_AUTHORIZATION_ONLY.
 */
...
export function evaluateFeedHostActivationGate(
  ...
  const reasons: string[] = [
    "Phase 3B.3.31 authorizes Adaptive Workspace Host Activation transaction opening only; the issuance transaction remains NOT_OPENED and deferred to 3B.3.32+",
  ];
