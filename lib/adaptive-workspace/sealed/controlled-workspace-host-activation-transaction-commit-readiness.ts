 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.35 prepared transaction state to declare commit
 * readiness metadata. Does not authorize or perform commit/abort, and does not
...
import {
  ...
  evaluateControlledWorkspaceHostActivationTransactionPreparation as evaluatePredecessorPreparation,
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_36_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_ONLY =
  "PHASE_3B3_36_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-commit-readiness.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-commit-readiness.contract.v1" as const;


export type ControlledWorkspaceHostActivationTransactionCommitReadinessState =
  | "TRANSACTION_COMMIT_READY_NOT_COMMITTED"
  | "BLOCKED";

export type ControlledWorkspaceHostActivationTransactionCommitReadinessResult =
  | "controlled-workspace-host-activation-transaction-commit-ready-not-committed"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-missing-readiness"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-missing-preparation-authorization"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-duplicate-preparation"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-predecessor"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-readiness"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-selection"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-candidate"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-contract"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-duplicate-commit-readiness"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-duplicate-entry"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-boundary-executable"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-runtime-capability"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-runtime-host"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-activation-handle"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-workspace-render"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-second-geofeed"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-runtime-mutation"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-shell"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-ownership"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-renderer"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-writer"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-pipeline"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-transaction"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-armed"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-crossed"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-committed"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-aborted"
  | "controlled-workspace-host-activation-transaction-commit-readiness-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostActivationTransactionCommitReadinessRecord = {
...
export type ControlledWorkspaceHostActivationTransactionCommitReadinessDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_SCHEMA_VERSION;
  readonly phase: "3B.3.36";
  readonly previousPhase: "3B.3.35";
  readonly currentPhase: "3B.3.36";
  readonly nextEligibleStep: "3B.3.37";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly transactionCommitReadinessState: "TRANSACTION_COMMIT_READY_NOT_COMMITTED";
  readonly transactionCommitReadinessResult: "controlled-workspace-host-activation-transaction-commit-ready-not-committed";
  ...
  readonly transactionCommitReadinessCount: 1;
  ...
  readonly duplicateTransactionCommitReadinessCount: 0;
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionCommitReadinessRecords: readonly [ControlledWorkspaceHostActivationTransactionCommitReadinessRecord];
  readonly predecessorActivationTransactionPreparationResult: "controlled-workspace-host-activation-transaction-prepared-not-committed";
  readonly predecessorActivationTransactionPreparationState: "TRANSACTION_PREPARED_NOT_COMMITTED";
  ...
  readonly activationBlocker: typeof PHASE_3B3_36_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostActivationTransactionCommitReadinessDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostActivationTransactionCommitReadinessEvaluation = {
  readonly descriptor: ControlledWorkspaceHostActivationTransactionCommitReadinessDescriptor;
  readonly diagnostics: ControlledWorkspaceHostActivationTransactionCommitReadinessDiagnostics;
};

export type ControlledWorkspaceHostActivationTransactionCommitReadinessInput = {
  readonly entry?: Partial<ControlledWorkspaceHostActivationTransactionCommitReadinessRecord> &
...
function createCommitReadinessRecord(): ControlledWorkspaceHostActivationTransactionCommitReadinessRecord {
...
function blockedResultFor(
  input: ControlledWorkspaceHostActivationTransactionCommitReadinessInput | undefined,
): ControlledWorkspaceHostActivationTransactionCommitReadinessResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-candidate";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-pipeline";
  }
  ...
  if (input.transactionCommitReady === true) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-duplicate-commit-readiness";
  }
  if (input.transactionOpeningReady === false) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-missing-readiness";
  }
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === false) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-missing-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-illegal-transition";
  }
  ...
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-commit-readiness-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostActivationTransactionCommitReadinessDescriptor(): ControlledWorkspaceHostActivationTransactionCommitReadinessDescriptor {
  const record = createCommitReadinessRecord();
  return validateControlledWorkspaceHostActivationTransactionCommitReadinessDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_SCHEMA_VERSION,
      phase: "3B.3.36",
      previousPhase: "3B.3.35",
      currentPhase: "3B.3.36",
      ...
      certificatePresent: false,
      permitPresent: false,
      transactionCommitReadinessRecords: [record],
      ...
      activationBlocker:
        PHASE_3B3_36_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostActivationTransactionCommitReadinessDescriptor(
  d: ControlledWorkspaceHostActivationTransactionCommitReadinessDescriptor,
): ControlledWorkspaceHostActivationTransactionCommitReadinessDescriptor {
  if (
    d.phase !== "3B.3.36" ||
    d.previousPhase !== "3B.3.35" ||
    d.currentPhase !== "3B.3.36" ||
    d.nextEligibleStep !== "3B.3.37"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_PHASE",
      "Phase chain must be 3B.3.35 → 3B.3.36 → 3B.3.37",
    );
  }
  if (
    d.transactionCommitReadinessState !== "TRANSACTION_COMMIT_READY_NOT_COMMITTED" ||
    d.transactionCommitReadinessResult !==
      "controlled-workspace-host-activation-transaction-commit-ready-not-committed"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_RESULT",
      "Successful commit readiness must be TRANSACTION_COMMIT_READY_NOT_COMMITTED",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_IDENTITY",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_FLAGS",
      "Transaction commit readiness requires opening completed, preparation ready+authorized+prepared, transactionCommitReady=true, OPENED not committed/aborted",
    );
  }
  if (
    d.candidateCount !== 1 ||
    ...
    d.transactionCommitReadinessCount !== 1 ||
    d.duplicateTransactionPreparationCount !== 0 ||
    d.duplicateTransactionCommitReadinessCount !== 0 ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_TRANSITION",
      "Only the legal NOT_ENTERED → ENTERED transition may be recorded",
    );
  }
  if (
    d.predecessorActivationTransactionPreparationState !== "TRANSACTION_PREPARED_NOT_COMMITTED" ||
    d.predecessorActivationTransactionPreparationResult !==
      "controlled-workspace-host-activation-transaction-prepared-not-committed" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_RUNTIME",
...
export function evaluateControlledWorkspaceHostActivationTransactionCommitReadiness(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostActivationTransactionCommitReadinessInput,
): ControlledWorkspaceHostActivationTransactionCommitReadinessEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_REGISTRY",
      "Transaction commit-readiness requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluatePredecessorPreparation(registry);
  const pred = predecessor.descriptor;

  if (
    pred.transactionPreparationResult !==
      "controlled-workspace-host-activation-transaction-prepared-not-committed" ||
    pred.transactionPreparationState !== "TRANSACTION_PREPARED_NOT_COMMITTED" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_PREDECESSOR_LIVE",
      "Predecessor preparation must remain PREPARED_NOT_COMMITTED with transaction OPENED prepared",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_BLOCKED",
      blocked,
    );
  }
  ...
  const record = descriptor.transactionCommitReadinessRecords[0];
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningAllowed: false,
      activationExecutionAllowed: false,
      transactionCommitReadinessResult: descriptor.transactionCommitReadinessResult,
      transactionCommitReadinessState: descriptor.transactionCommitReadinessState,
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_READINESS_BLOCKERS,
      transactionCommitReadinessRecords: descriptor.transactionCommitReadinessRecords,
    },
  };
}
