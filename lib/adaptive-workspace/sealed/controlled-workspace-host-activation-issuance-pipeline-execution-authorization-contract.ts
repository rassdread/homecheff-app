/**
 * Phase 3B.3.40 — Controlled Workspace Host Activation Issuance Pipeline Execution Authorization Contract.
 */
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_CONTRACT_SCHEMA_VERSION =
  1 as const;

export type ControlledWorkspaceHostActivationIssuancePipelineExecutionAuthorizationContract = {
  schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_CONTRACT_SCHEMA_VERSION;
  phase: "3B.3.40";
  ...
  contractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_CONTRACT_ID;
  ...
  activationRestriction: typeof PHASE_3B3_40_CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_ONLY;
  nextEligibleStep: "3B.3.41";
};

export function createControlledWorkspaceHostActivationIssuancePipelineExecutionAuthorizationContract(): ControlledWorkspaceHostActivationIssuancePipelineExecutionAuthorizationContract {
  return validateControlledWorkspaceHostActivationIssuancePipelineExecutionAuthorizationContract({
    schemaVersion:
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_CONTRACT_SCHEMA_VERSION,
    phase: "3B.3.40",
    previousPhase: "3B.3.39",
    widgetId: "feed.discovery",
    ...
    activationTransactionCommitId:
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_ID,
    contractId: CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_CONTRACT_ID,
...
export function validateControlledWorkspaceHostActivationIssuancePipelineExecutionAuthorizationContract(
  candidate: unknown,
): ControlledWorkspaceHostActivationIssuancePipelineExecutionAuthorizationContract {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_CONTRACT_INVALID",
      "Transaction commit contract must be a plain object",
    );
  }
  const c = candidate as ControlledWorkspaceHostActivationIssuancePipelineExecutionAuthorizationContract;
  if (
    c.phase !== "3B.3.40" ||
    c.previousPhase !== "3B.3.39" ||
    c.nextEligibleStep !== "3B.3.41"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_CONTRACT_PHASE",
      "phase must be 3B.3.40 with previousPhase 3B.3.39",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_CONTRACT_FLAGS",
