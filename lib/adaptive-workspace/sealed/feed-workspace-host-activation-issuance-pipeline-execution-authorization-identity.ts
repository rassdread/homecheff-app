/**
 * Phase 3B.3.40 — Workspace host activation transaction-commit identity contract.
 */
...
export const FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_IDENTITY_SCHEMA_VERSION =
  1 as const;

export type FeedWorkspaceHostActivationIssuancePipelineExecutionAuthorizationIdentity = {
  schemaVersion: typeof FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_IDENTITY_SCHEMA_VERSION;
  phase: "3B.3.40";
...
export function createFeedWorkspaceHostActivationIssuancePipelineExecutionAuthorizationIdentity(): FeedWorkspaceHostActivationIssuancePipelineExecutionAuthorizationIdentity {
  return validateFeedWorkspaceHostActivationIssuancePipelineExecutionAuthorizationIdentity({
    schemaVersion:
      FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_IDENTITY_SCHEMA_VERSION,
    phase: "3B.3.40",
...
export function validateFeedWorkspaceHostActivationIssuancePipelineExecutionAuthorizationIdentity(
  candidate: unknown,
): FeedWorkspaceHostActivationIssuancePipelineExecutionAuthorizationIdentity {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_IDENTITY_INVALID",
      "Commit-readiness identity must be a plain object",
    );
  }
  const c = candidate as FeedWorkspaceHostActivationIssuancePipelineExecutionAuthorizationIdentity;
  if (c.phase !== "3B.3.40") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_IDENTITY_PHASE",
      "phase must be 3B.3.40",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_IDENTITY_CHAIN",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_IDENTITY_TRANSFER",
