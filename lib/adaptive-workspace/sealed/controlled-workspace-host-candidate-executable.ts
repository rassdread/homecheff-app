 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.45 candidate activation state to declare
 * candidate-activation metadata. Advances candidateExecutable metadata only. Does not execute the candidate, unlock Allowed/Executable, or render Workspace.
 */
...
import {
  ...
  evaluateControlledWorkspaceHostCandidateActive as evaluatePredecessorCandidateActive,
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_46_CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ONLY =
  "PHASE_3B3_46_CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ID =
  "feed.discovery.adaptive-workspace.host-candidate-executable.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-candidate-executable.contract.v1" as const;


export type ControlledWorkspaceHostCandidateExecutableState =
  | "CANDIDATE_EXECUTABLE_NOT_EXECUTED"
  | "BLOCKED";

export type ControlledWorkspaceHostCandidateExecutableResult =
  | "controlled-workspace-host-candidate-executable-not-executed"
  | "controlled-workspace-host-candidate-executable-blocked-missing-readiness"
  | "controlled-workspace-host-candidate-executable-blocked-missing-authorization"
  | "controlled-workspace-host-candidate-executable-blocked-duplicate-activation"
  | "controlled-workspace-host-candidate-executable-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-candidate-executable-blocked-missing-preparation-authorization"
  | "controlled-workspace-host-candidate-executable-blocked-duplicate-preparation"
  | "controlled-workspace-host-candidate-executable-blocked-invalid-predecessor"
  | "controlled-workspace-host-candidate-executable-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-candidate-executable-blocked-invalid-readiness"
  | "controlled-workspace-host-candidate-executable-blocked-invalid-selection"
  | "controlled-workspace-host-candidate-executable-blocked-invalid-candidate"
  | "controlled-workspace-host-candidate-executable-blocked-invalid-contract"
  | "controlled-workspace-host-candidate-executable-blocked-duplicate-commit-readiness"
  | "controlled-workspace-host-candidate-executable-blocked-duplicate-commit"
  | "controlled-workspace-host-candidate-executable-blocked-missing-commit-readiness"
  | "controlled-workspace-host-candidate-executable-blocked-missing-commit-authorization"
  | "controlled-workspace-host-candidate-executable-blocked-duplicate-entry"
  | "controlled-workspace-host-candidate-executable-blocked-boundary-executable"
  | "controlled-workspace-host-candidate-executable-blocked-runtime-capability"
  | "controlled-workspace-host-candidate-executable-blocked-runtime-host"
  | "controlled-workspace-host-candidate-executable-blocked-activation-handle"
  | "controlled-workspace-host-candidate-executable-blocked-workspace-render"
  | "controlled-workspace-host-candidate-executable-blocked-second-geofeed"
  | "controlled-workspace-host-candidate-executable-blocked-runtime-mutation"
  | "controlled-workspace-host-candidate-executable-blocked-shell"
  | "controlled-workspace-host-candidate-executable-blocked-ownership"
  | "controlled-workspace-host-candidate-executable-blocked-renderer"
  | "controlled-workspace-host-candidate-executable-blocked-writer"
  | "controlled-workspace-host-candidate-executable-blocked-pipeline"
  | "controlled-workspace-host-candidate-executable-blocked-transaction"
  | "controlled-workspace-host-candidate-executable-blocked-armed"
  | "controlled-workspace-host-candidate-executable-blocked-crossed"
  | "controlled-workspace-host-candidate-executable-blocked-committed"
  | "controlled-workspace-host-candidate-executable-blocked-aborted"
  | "controlled-workspace-host-candidate-executable-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostCandidateExecutableDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_SCHEMA_VERSION;
  readonly phase: "3B.3.46";
  readonly previousPhase: "3B.3.45";
  readonly currentPhase: "3B.3.46";
  readonly nextEligibleStep: "3B.3.47";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly candidateActivationState: "CANDIDATE_EXECUTABLE_NOT_EXECUTED";
  readonly candidateActivationResult: "controlled-workspace-host-candidate-executable-not-executed";
  ...
  readonly activationBlocker: typeof PHASE_3B3_46_CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostCandidateExecutableDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostCandidateExecutableEvaluation = {
  readonly descriptor: ControlledWorkspaceHostCandidateExecutableDescriptor;
  readonly diagnostics: ControlledWorkspaceHostCandidateExecutableDiagnostics;
};

export type ControlledWorkspaceHostCandidateExecutableInput = {
...
function blockedResultFor(
  input: ControlledWorkspaceHostCandidateExecutableInput | undefined,
): ControlledWorkspaceHostCandidateExecutableResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-executable-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-candidate-executable-blocked-invalid-grant-issuance";
  }
  ...
  if (input.candidateExecutable === true) {
    return "controlled-workspace-host-candidate-executable-blocked-duplicate-activation";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-executable-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-candidate-executable-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionAllowed === true) {
    return "controlled-workspace-host-candidate-executable-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionReady === false) {
    return "controlled-workspace-host-candidate-executable-blocked-missing-readiness";
  }
  ...
  if (input.candidateActivationAuthorized === false) {
    return "controlled-workspace-host-candidate-executable-blocked-missing-authorization";
  }
  ...
  if (input.transactionCommitReady === false) {
    return "controlled-workspace-host-candidate-executable-blocked-missing-commit-readiness";
  }
  if (input.transactionCommitAuthorized === false) {
    return "controlled-workspace-host-candidate-executable-blocked-missing-commit-authorization";
  }
  ...
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-candidate-executable-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-candidate-executable-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === false) {
    return "controlled-workspace-host-candidate-executable-blocked-missing-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-candidate-executable-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-candidate-executable-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-candidate-executable-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-candidate-executable-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-executable-blocked-illegal-transition";
  }
  ...
  if (input.candidates && input.candidates.length !== 1) {
    return "controlled-workspace-host-candidate-executable-blocked-invalid-candidate";
  }
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-candidate-executable-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-candidate-executable-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-executable-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-candidate-executable-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-candidate-executable-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-candidate-executable-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-candidate-executable-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-candidate-executable-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-executable-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-candidate-executable-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-executable-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-executable-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-candidate-executable-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-candidate-executable-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-candidate-executable-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostCandidateExecutableDescriptor(): ControlledWorkspaceHostCandidateExecutableDescriptor {
  const record = createCommitRecord();
  return validateControlledWorkspaceHostCandidateExecutableDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_SCHEMA_VERSION,
      phase: "3B.3.46",
      previousPhase: "3B.3.45",
      currentPhase: "3B.3.46",
      ...
      activationBlocker:
        PHASE_3B3_46_CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostCandidateExecutableDescriptor(
  d: ControlledWorkspaceHostCandidateExecutableDescriptor,
): ControlledWorkspaceHostCandidateExecutableDescriptor {
  if (
    d.phase !== "3B.3.46" ||
    d.previousPhase !== "3B.3.45" ||
    d.currentPhase !== "3B.3.46" ||
    d.nextEligibleStep !== "3B.3.47"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_PHASE",
      "Phase chain must be 3B.3.45 → 3B.3.46 → 3B.3.47",
    );
  }
  if (
    d.candidateActivationState !== "CANDIDATE_EXECUTABLE_NOT_EXECUTED" ||
    d.candidateActivationResult !==
      "controlled-workspace-host-candidate-executable-not-executed"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_RESULT",
      "Successful candidate activation must be CANDIDATE_EXECUTABLE_NOT_EXECUTED",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_IDENTITY",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_FLAGS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_TRANSITION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_RUNTIME",
...
export function evaluateControlledWorkspaceHostCandidateExecutable(
  ...
  if (
    ...
    pred.candidateExecutable !== false ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_PREDECESSOR_LIVE",
      "Predecessor candidate active must remain ACTIVE_NOT_EXECUTABLE with candidateExecutable=false and NON_EXECUTABLE pipeline",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_BLOCKED",
      blocked,
    );
  }
  ...
  return {
    ...
    diagnostics: {
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_BLOCKERS,
