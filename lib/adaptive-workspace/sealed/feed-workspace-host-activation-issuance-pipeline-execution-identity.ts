/**
 * Phase 3B.3.41 — Workspace host activation issuance-pipeline-execution identity contract.
 */
...
export const FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_IDENTITY_SCHEMA_VERSION =
  1 as const;

export type FeedWorkspaceHostActivationIssuancePipelineExecutionIdentity = {
  schemaVersion: typeof FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_IDENTITY_SCHEMA_VERSION;
  phase: "3B.3.41";
...
export function createFeedWorkspaceHostActivationIssuancePipelineExecutionIdentity(): FeedWorkspaceHostActivationIssuancePipelineExecutionIdentity {
  return validateFeedWorkspaceHostActivationIssuancePipelineExecutionIdentity({
    schemaVersion:
      FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_IDENTITY_SCHEMA_VERSION,
    phase: "3B.3.41",
...
export function validateFeedWorkspaceHostActivationIssuancePipelineExecutionIdentity(
  candidate: unknown,
): FeedWorkspaceHostActivationIssuancePipelineExecutionIdentity {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_IDENTITY_INVALID",
      "Commit-readiness identity must be a plain object",
    );
  }
  const c = candidate as FeedWorkspaceHostActivationIssuancePipelineExecutionIdentity;
  if (c.phase !== "3B.3.41") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_IDENTITY_PHASE",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_IDENTITY_CHAIN",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_IDENTITY_TRANSFER",
