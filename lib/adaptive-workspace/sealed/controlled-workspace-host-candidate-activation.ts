 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.43 candidate-activation authorization state to declare
 * candidate-activation metadata. Does not set candidateActive, unlock Allowed/Executable,
 * or render Workspace.
 */
...
import {
  ...
  evaluateControlledWorkspaceHostCandidateActivationAuthorization as evaluatePredecessorCandidateActivationAuthorization,
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_44_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ONLY =
  "PHASE_3B3_44_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ID =
  "feed.discovery.adaptive-workspace.host-candidate-activation.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-candidate-activation.contract.v1" as const;


export type ControlledWorkspaceHostCandidateActivationState =
  | "CANDIDATE_ACTIVATED_NOT_ACTIVE"
  | "BLOCKED";

export type ControlledWorkspaceHostCandidateActivationResult =
  | "controlled-workspace-host-candidate-activated-not-active"
  | "controlled-workspace-host-candidate-activation-blocked-missing-readiness"
  | "controlled-workspace-host-candidate-activation-blocked-missing-authorization"
  | "controlled-workspace-host-candidate-activation-blocked-duplicate-activation"
  | "controlled-workspace-host-candidate-activation-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-candidate-activation-blocked-missing-preparation-authorization"
  | "controlled-workspace-host-candidate-activation-blocked-duplicate-preparation"
  | "controlled-workspace-host-candidate-activation-blocked-invalid-predecessor"
  | "controlled-workspace-host-candidate-activation-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-candidate-activation-blocked-invalid-readiness"
  | "controlled-workspace-host-candidate-activation-blocked-invalid-selection"
  | "controlled-workspace-host-candidate-activation-blocked-invalid-candidate"
  | "controlled-workspace-host-candidate-activation-blocked-invalid-contract"
  | "controlled-workspace-host-candidate-activation-blocked-duplicate-commit-readiness"
  | "controlled-workspace-host-candidate-activation-blocked-duplicate-commit"
  | "controlled-workspace-host-candidate-activation-blocked-missing-commit-readiness"
  | "controlled-workspace-host-candidate-activation-blocked-missing-commit-authorization"
  | "controlled-workspace-host-candidate-activation-blocked-duplicate-entry"
  | "controlled-workspace-host-candidate-activation-blocked-boundary-executable"
  | "controlled-workspace-host-candidate-activation-blocked-runtime-capability"
  | "controlled-workspace-host-candidate-activation-blocked-runtime-host"
  | "controlled-workspace-host-candidate-activation-blocked-activation-handle"
  | "controlled-workspace-host-candidate-activation-blocked-workspace-render"
  | "controlled-workspace-host-candidate-activation-blocked-second-geofeed"
  | "controlled-workspace-host-candidate-activation-blocked-runtime-mutation"
  | "controlled-workspace-host-candidate-activation-blocked-shell"
  | "controlled-workspace-host-candidate-activation-blocked-ownership"
  | "controlled-workspace-host-candidate-activation-blocked-renderer"
  | "controlled-workspace-host-candidate-activation-blocked-writer"
  | "controlled-workspace-host-candidate-activation-blocked-pipeline"
  | "controlled-workspace-host-candidate-activation-blocked-transaction"
  | "controlled-workspace-host-candidate-activation-blocked-armed"
  | "controlled-workspace-host-candidate-activation-blocked-crossed"
  | "controlled-workspace-host-candidate-activation-blocked-committed"
  | "controlled-workspace-host-candidate-activation-blocked-aborted"
  | "controlled-workspace-host-candidate-activation-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostCandidateActivationDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_SCHEMA_VERSION;
  readonly phase: "3B.3.44";
  readonly previousPhase: "3B.3.43";
  readonly currentPhase: "3B.3.44";
  readonly nextEligibleStep: "3B.3.45";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly candidateActivationState: "CANDIDATE_ACTIVATED_NOT_ACTIVE";
  readonly candidateActivationResult: "controlled-workspace-host-candidate-activated-not-active";
  ...
  readonly activationBlocker: typeof PHASE_3B3_44_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostCandidateActivationDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostCandidateActivationEvaluation = {
  readonly descriptor: ControlledWorkspaceHostCandidateActivationDescriptor;
  readonly diagnostics: ControlledWorkspaceHostCandidateActivationDiagnostics;
};

export type ControlledWorkspaceHostCandidateActivationInput = {
...
function blockedResultFor(
  input: ControlledWorkspaceHostCandidateActivationInput | undefined,
): ControlledWorkspaceHostCandidateActivationResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-candidate-activation-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-candidate-activation-blocked-duplicate-activation";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-candidate-activation-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionAllowed === true) {
    return "controlled-workspace-host-candidate-activation-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionReady === false) {
    return "controlled-workspace-host-candidate-activation-blocked-missing-readiness";
  }
  ...
  if (input.candidateActivationAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-blocked-missing-authorization";
  }
  ...
  if (input.transactionCommitReady === false) {
    return "controlled-workspace-host-candidate-activation-blocked-missing-commit-readiness";
  }
  if (input.transactionCommitAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-blocked-missing-commit-authorization";
  }
  ...
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-candidate-activation-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-blocked-missing-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-candidate-activation-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-candidate-activation-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-candidate-activation-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-candidate-activation-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-blocked-illegal-transition";
  }
  ...
  if (input.candidates && input.candidates.length !== 1) {
    return "controlled-workspace-host-candidate-activation-blocked-invalid-candidate";
  }
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-candidate-activation-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-candidate-activation-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-activation-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-candidate-activation-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-candidate-activation-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-candidate-activation-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-candidate-activation-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-candidate-activation-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-activation-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-candidate-activation-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-activation-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-activation-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-candidate-activation-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-candidate-activation-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-candidate-activation-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostCandidateActivationDescriptor(): ControlledWorkspaceHostCandidateActivationDescriptor {
  const record = createCommitRecord();
  return validateControlledWorkspaceHostCandidateActivationDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_SCHEMA_VERSION,
      phase: "3B.3.44",
      previousPhase: "3B.3.43",
      currentPhase: "3B.3.44",
      ...
      activationBlocker:
        PHASE_3B3_44_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostCandidateActivationDescriptor(
  d: ControlledWorkspaceHostCandidateActivationDescriptor,
): ControlledWorkspaceHostCandidateActivationDescriptor {
  if (
    d.phase !== "3B.3.44" ||
    d.previousPhase !== "3B.3.43" ||
    d.currentPhase !== "3B.3.44" ||
    d.nextEligibleStep !== "3B.3.45"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_PHASE",
      "Phase chain must be 3B.3.43 → 3B.3.44 → 3B.3.45",
    );
  }
  if (
    d.candidateActivationState !== "CANDIDATE_ACTIVATED_NOT_ACTIVE" ||
    d.candidateActivationResult !==
      "controlled-workspace-host-candidate-activated-not-active"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_RESULT",
      "Successful candidate activation must be CANDIDATE_ACTIVATED_NOT_ACTIVE",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_IDENTITY",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_FLAGS",
  ...
  if (
    ...
    d.candidateActive !== false ||
    d.candidateExecutable !== false ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_TRANSITION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_RUNTIME",
...
export function evaluateControlledWorkspaceHostCandidateActivation(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostCandidateActivationInput,
): ControlledWorkspaceHostCandidateActivationEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_REGISTRY",
      "Candidate activation authorization requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluatePredecessorCandidateActivationAuthorization(registry);
  const pred = predecessor.descriptor;

  if (
    pred.candidateActivationAuthorizationResult !==
      "controlled-workspace-host-candidate-activation-authorized-not-activated" ||
    pred.candidateActivationAuthorizationState !== "CANDIDATE_ACTIVATION_AUTHORIZED_NOT_ACTIVATED" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_PREDECESSOR_LIVE",
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_BLOCKED",
      blocked,
    );
  }

  const descriptor =
    createControlledWorkspaceHostCandidateActivationDescriptor();
  ...
  return {
    ...
    diagnostics: {
      ...
      predecessorActivationBlocker:
        PHASE_3B3_43_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ONLY,
      conditionCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONDITIONS.length,
      satisfiedConditionCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONDITIONS.length,
      unsatisfiedConditionCount: 0,
      guardCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_GUARDS.length,
      satisfiedGuardCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_GUARDS.length,
      unsatisfiedGuardCount: 0,
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_BLOCKERS,
