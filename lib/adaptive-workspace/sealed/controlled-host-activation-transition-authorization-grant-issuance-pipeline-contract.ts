/**
 * Phase 3B.3.21 — Controlled Host Activation Transition Authorization Grant Issuance Pipeline Contract (fail-closed).
 */
...
export const CONTROLLED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_SCHEMA_VERSION =
  1 as const;

export const CONTROLLED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_REQUIREMENTS = [
  ...
  "activation-transition-authorization-grant-issuance-pipeline-metadata-only",
  "activation-transition-authorization-grant-issuance-pipeline-diagnostics-readable",
  "deterministic-pure-issuance-pipeline-engine",
  "issuance-pipeline-only-no-executor-no-scheduler",
...
export type ControlledHostActivationTransitionAuthorizationGrantIssuancePipelineRequirement =
  (typeof CONTROLLED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_REQUIREMENTS)[number];

export type ControlledHostActivationTransitionAuthorizationGrantIssuancePipelineContract =
  {
    schemaVersion: typeof CONTROLLED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_SCHEMA_VERSION;
    phase: "3B.3.21";
    ...
    wouldActivate: true;
    issuancePipelineRequirements: readonly ControlledHostActivationTransitionAuthorizationGrantIssuancePipelineRequirement[];
    ...
    activationRestriction: typeof PHASE_3B3_21_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_ONLY;
...
export function createControlledHostActivationTransitionAuthorizationGrantIssuancePipelineContract(): ControlledHostActivationTransitionAuthorizationGrantIssuancePipelineContract {
  void evaluateControlledHostActivationTransitionAuthorizationGrantIssuancePipeline();
  return validateControlledHostActivationTransitionAuthorizationGrantIssuancePipelineContract(
    {
      schemaVersion:
...
export function validateControlledHostActivationTransitionAuthorizationGrantIssuancePipelineContract(
  candidate: unknown,
): ControlledHostActivationTransitionAuthorizationGrantIssuancePipelineContract {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_INVALID",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_SCHEMA",
      "Unsupported grant issuance plan contract schemaVersion",
    );
  }
  if (c.phase !== "3B.3.21" || c.widgetId !== "feed.discovery") {
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_PHASE",
      "phase must be 3B.3.21 and widgetId feed.discovery",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_IDS",
      "hostId/runtimeId must remain stable",
    );
  }
  if (
    c.issuancePipelineState !== "completed" ||
    c.issuancePipelineResult !== "authorization-grant-issuance-pipeline-ready-not-executable" ||
    ...
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_RESULT",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_LINK",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_FLAGS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_RESTRICTION",
      "activationRestriction must be PHASE_3B3_21_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_ONLY",
    );
  }
  for (const key of [
    "remountAllowed",
    ...
    if (c[key] !== false) {
      throw new HardContractViolation(
        "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_FORBIDDEN",
        `${key} must be false`,
      );
    }
  }
  if (c.nextEligibleStep !== "3B.3.22") {
    throw new HardContractViolation(
      "FEED_HOST_ACTIVATION_TRANSITION_AUTHORIZATION_GRANT_ISSUANCE_PIPELINE_CONTRACT_NEXT",
      "nextEligibleStep must be 3B.3.22",
    );
  }
  return c as ControlledHostActivationTransitionAuthorizationGrantIssuancePipelineContract;
}
