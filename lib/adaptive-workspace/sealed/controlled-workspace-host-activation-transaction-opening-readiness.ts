 ...
 * (metadata only).
 *
 * Proves the frozen Phase 3B.3.29 commit-boundary-entered state is legally ready
 * for a future controlled issuance-transaction opening authorization phase.
 * Does not open, prepare, commit, or abort the issuance transaction.
 */
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_30_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ONLY =
  "PHASE_3B3_30_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-opening-readiness.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-opening-readiness.contract.v1" as const;


export type ControlledWorkspaceHostActivationTransactionOpeningReadinessState =
  | "TRANSACTION_OPENING_READY_NOT_OPENED"
  | "BLOCKED";

export type ControlledWorkspaceHostActivationTransactionOpeningReadinessResult =
  | "controlled-workspace-host-activation-transaction-opening-ready-not-opened"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-predecessor"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-readiness"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-selection"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-candidate"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-contract"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-duplicate-entry"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-boundary-executable"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-runtime-capability"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-runtime-host"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-activation-handle"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-workspace-render"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-second-geofeed"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-runtime-mutation"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-shell"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-ownership"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-renderer"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-writer"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-pipeline"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-transaction"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-armed"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-crossed"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-committed"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-aborted"
  | "controlled-workspace-host-activation-transaction-opening-readiness-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_BLOCKERS =
  Object.freeze([
    "PHASE_3B3_30_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ONLY",
    "PHASE_3B3_30_METADATA_ONLY",
    "PHASE_3B3_30_ACTIVATION_FORBIDDEN",
    "PHASE_3B3_30_ACTIVE_STATE_FORBIDDEN",
    "PHASE_3B3_30_EXECUTION_FORBIDDEN",
    "PHASE_3B3_30_BOUNDARY_EXECUTION_FORBIDDEN",
    "PHASE_3B3_30_BOUNDARY_MUTATION_FORBIDDEN",
    "PHASE_3B3_30_BOUNDARY_DUPLICATION_FORBIDDEN",
    "PHASE_3B3_30_SECOND_ENTRY_FORBIDDEN",
    "PHASE_3B3_30_RUNTIME_HOST_FORBIDDEN",
    "PHASE_3B3_30_HOST_INSTANCE_FORBIDDEN",
    "PHASE_3B3_30_RUNTIME_CAPABILITY_FORBIDDEN",
    "PHASE_3B3_30_ACTIVATION_HANDLE_FORBIDDEN",
    "PHASE_3B3_30_AUTHORITY_HANDLE_FORBIDDEN",
    "PHASE_3B3_30_CREDENTIAL_FORBIDDEN",
    "PHASE_3B3_30_TOKEN_FORBIDDEN",
    "PHASE_3B3_30_CERTIFICATE_FORBIDDEN",
    "PHASE_3B3_30_PERMIT_FORBIDDEN",
    "PHASE_3B3_30_COMMAND_FORBIDDEN",
    "PHASE_3B3_30_CALLBACK_FORBIDDEN",
    "PHASE_3B3_30_DISPATCHER_FORBIDDEN",
    "PHASE_3B3_30_QUEUE_FORBIDDEN",
    "PHASE_3B3_30_SCHEDULER_FORBIDDEN",
    "PHASE_3B3_30_EXECUTOR_FORBIDDEN",
    "PHASE_3B3_30_PROVIDER_FORBIDDEN",
    "PHASE_3B3_30_SERVICE_FORBIDDEN",
    "PHASE_3B3_30_COORDINATOR_FORBIDDEN",
    "PHASE_3B3_30_RUNTIME_REGISTRY_FORBIDDEN",
    "PHASE_3B3_30_MUTABLE_REGISTRY_FORBIDDEN",
    "PHASE_3B3_30_BOUNDARY_ARM_FORBIDDEN",
    "PHASE_3B3_30_BOUNDARY_CROSS_FORBIDDEN",
    "PHASE_3B3_30_BOUNDARY_COMMIT_FORBIDDEN",
    "PHASE_3B3_30_BOUNDARY_ABORT_FORBIDDEN",
    "PHASE_3B3_30_TRANSACTION_OPEN_FORBIDDEN",
    "PHASE_3B3_30_PIPELINE_EXECUTION_FORBIDDEN",
    "PHASE_3B3_30_OWNERSHIP_TRANSFER_FORBIDDEN",
    "PHASE_3B3_30_WRITER_TRANSFER_FORBIDDEN",
    "PHASE_3B3_30_RENDERER_TRANSFER_FORBIDDEN",
    "PHASE_3B3_30_RUNTIME_ADOPTION_FORBIDDEN",
    "PHASE_3B3_30_GEOFEED_RELOCATION_FORBIDDEN",
    "PHASE_3B3_30_SECOND_GEOFEED_FORBIDDEN",
    "PHASE_3B3_30_GEOFEED_WRAP_FORBIDDEN",
    "PHASE_3B3_30_GEOFEED_CLONE_FORBIDDEN",
    "PHASE_3B3_30_WORKSPACE_RENDER_FORBIDDEN",
    "PHASE_3B3_30_WORKSPACE_MOUNT_FORBIDDEN",
    "PHASE_3B3_30_WORKSPACE_REACT_INSTANCE_FORBIDDEN",
    "PHASE_3B3_30_VISIBLE_UI_FORBIDDEN",
    "PHASE_3B3_30_DOM_MUTATION_FORBIDDEN",
    "PHASE_3B3_30_RUNTIME_MUTATION_FORBIDDEN",
    "PHASE_3B3_30_REQUEST_MUTATION_FORBIDDEN",
    "PHASE_3B3_30_CACHE_MUTATION_FORBIDDEN",
    "PHASE_3B3_30_OBSERVER_MUTATION_FORBIDDEN",
    "PHASE_3B3_30_NETWORK_FORBIDDEN",
    "PHASE_3B3_30_PERSISTENCE_FORBIDDEN",
    "PHASE_3B3_30_DATE_DEPENDENCY_FORBIDDEN",
    "PHASE_3B3_30_RANDOMNESS_FORBIDDEN",
    "PHASE_3B3_30_ILLEGAL_TRANSITION_FORBIDDEN",
  ] as const);

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONDITIONS =
  Object.freeze([
    "phase-3b329-active",
    "previous-phase-3b328-complete",
    "next-eligible-step-3b330",
    "transaction-opening-readiness-result-exact",
    "transaction-opening-readiness-state-exact",
    ...
    "activation-transaction-opening-readiness-identity-exact",
    "activation-transaction-opening-readiness-contract-identity-exact",
    ...
    "exactly-one-grant",
    "exactly-one-transaction-opening-readiness",
    ...
    "transaction-opening-readiness-identity-unique",
    ...
    "transaction-opening-readiness-not-allowed-after-entry",
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_GUARDS =
  Object.freeze([
    ...
    "activation-transaction-opening-readiness-identity-exactness",
    "candidate-uniqueness",
    "grant-uniqueness",
    "commit-boundary-uniqueness",
    "transaction-opening-readiness-uniqueness",
...
export type ControlledWorkspaceHostActivationTransactionOpeningReadinessRecord = {
  ...
  readonly activationTransactionOpeningReadinessAllowed: false;
...
export type ControlledWorkspaceHostActivationTransactionOpeningReadinessDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_SCHEMA_VERSION;
  readonly phase: "3B.3.30";
  readonly previousPhase: "3B.3.29";
  readonly currentPhase: "3B.3.30";
  readonly nextEligibleStep: "3B.3.31";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly transactionOpeningReadinessState: "TRANSACTION_OPENING_READY_NOT_OPENED";
  readonly transactionOpeningReadinessResult: "controlled-workspace-host-activation-transaction-opening-ready-not-opened";
  readonly transactionOpeningReadinessCompleted: true;
  readonly transactionOpeningReady: true;
  readonly transactionOpeningAuthorized: false;
  readonly transactionOpeningStarted: false;
  readonly transactionOpeningCompleted: false;
  ...
  readonly transactionOpeningReadinessCount: 1;
  ...
  readonly duplicateTransactionOpeningReadinessCount: 0;
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionOpeningReadinessRecords: readonly [ControlledWorkspaceHostActivationTransactionOpeningReadinessRecord];
  ...
  readonly activationBlocker: typeof PHASE_3B3_30_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostActivationTransactionOpeningReadinessDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostActivationTransactionOpeningReadinessEvaluation = {
  readonly descriptor: ControlledWorkspaceHostActivationTransactionOpeningReadinessDescriptor;
  readonly diagnostics: ControlledWorkspaceHostActivationTransactionOpeningReadinessDiagnostics;
};

export type ControlledWorkspaceHostActivationTransactionOpeningReadinessInput = {
  readonly entry?: Partial<ControlledWorkspaceHostActivationTransactionOpeningReadinessRecord> &
...
function createTransactionOpeningReadinessRecord(): ControlledWorkspaceHostActivationTransactionOpeningReadinessRecord {
...
function blockedResultFor(
  input: ControlledWorkspaceHostActivationTransactionOpeningReadinessInput | undefined,
): ControlledWorkspaceHostActivationTransactionOpeningReadinessResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-candidate";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-pipeline";
  }
  ...
  if (
    input.transactionOpeningAuthorized === true ||
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-illegal-transition";
  }
  ...
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-second-geofeed";
    }
    if (
      ...
      r.activationTransactionOpeningReadinessAllowed === true ||
      r.activationExecutionAllowed === true
    ) {
      return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-opening-readiness-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostActivationTransactionOpeningReadinessDescriptor(): ControlledWorkspaceHostActivationTransactionOpeningReadinessDescriptor {
  const record = createTransactionOpeningReadinessRecord();
  return validateControlledWorkspaceHostActivationTransactionOpeningReadinessDescriptor(
    {
      schemaVersion:
      ...
      certificatePresent: false,
      permitPresent: false,
      transactionOpeningReadinessRecords: [record],
      ...
      activationBlocker:
        PHASE_3B3_30_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostActivationTransactionOpeningReadinessDescriptor(
  d: ControlledWorkspaceHostActivationTransactionOpeningReadinessDescriptor,
): ControlledWorkspaceHostActivationTransactionOpeningReadinessDescriptor {
  if (
    d.phase !== "3B.3.30" ||
    d.previousPhase !== "3B.3.29" ||
    d.currentPhase !== "3B.3.30" ||
    d.nextEligibleStep !== "3B.3.31"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_PHASE",
      "Phase chain must be 3B.3.29 → 3B.3.30 → 3B.3.31",
    );
  }
  if (
    d.transactionOpeningReadinessState !== "TRANSACTION_OPENING_READY_NOT_OPENED" ||
    d.transactionOpeningReadinessResult !==
      "controlled-workspace-host-activation-transaction-opening-ready-not-opened"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_RESULT",
      "Successful readiness must be TRANSACTION_OPENING_READY_NOT_OPENED",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_IDENTITY",
  ...
  if (
    ...
    d.grantCount !== 1 ||
    d.transactionOpeningReadinessCount !== 1 ||
    d.duplicateTransactionOpeningReadinessCount !== 0 ||
    d.candidateGranted !== true ||
    d.candidateActivated !== false ||
    d.grantExecutable !== false ||
    d.activationCommitBoundaryExecutable !== false ||
    d.activationTransactionOpeningReadinessAllowed !== false ||
    d.activationExecutionAllowed !== false
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_TRANSITION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_RUNTIME",
...
export function evaluateControlledWorkspaceHostActivationTransactionOpeningReadiness(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostActivationTransactionOpeningReadinessInput,
): ControlledWorkspaceHostActivationTransactionOpeningReadinessEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_REGISTRY",
      "Commit-boundary entry requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluateControlledWorkspaceHostActivationCommitBoundaryEntry(registry);
  const pred = predecessor.descriptor;

  if (
    pred.commitBoundaryEntryResult !==
      "controlled-workspace-host-activation-commit-boundary-entered" ||
    pred.commitBoundaryEntryState !== "COMMIT_BOUNDARY_ENTERED" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_PREDECESSOR_LIVE",
      "Predecessor commit-boundary entry must remain COMMIT_BOUNDARY_ENTERED with transaction NOT_OPENED",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_BLOCKED",
      blocked,
    );
  }
  ...
  const record = descriptor.transactionOpeningReadinessRecords[0];
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningReadinessAllowed: false,
      activationExecutionAllowed: false,
      transactionOpeningReadinessResult: descriptor.transactionOpeningReadinessResult,
      transactionOpeningReadinessState: descriptor.transactionOpeningReadinessState,
      ...
      guardCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_GUARDS.length,
      satisfiedGuardCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_GUARDS.length,
      unsatisfiedGuardCount: 0,
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_BLOCKERS,
      transactionOpeningReadinessRecords: descriptor.transactionOpeningReadinessRecords,
    },
  };
}
