/**
 * Phase 3B.3.42 — Workspace host activation candidate-activation-readiness identity contract.
 */
...
export const FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_IDENTITY_SCHEMA_VERSION =
  1 as const;

export type FeedWorkspaceHostCandidateActivationReadinessIdentity = {
  schemaVersion: typeof FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_IDENTITY_SCHEMA_VERSION;
  phase: "3B.3.42";
  ...
  activationCandidateActivationReadinessId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ID;
  activationCandidateActivationReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_ID;
...
export function createFeedWorkspaceHostCandidateActivationReadinessIdentity(): FeedWorkspaceHostCandidateActivationReadinessIdentity {
  return validateFeedWorkspaceHostCandidateActivationReadinessIdentity({
    schemaVersion:
      FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_IDENTITY_SCHEMA_VERSION,
    phase: "3B.3.42",
...
export function validateFeedWorkspaceHostCandidateActivationReadinessIdentity(
  candidate: unknown,
): FeedWorkspaceHostCandidateActivationReadinessIdentity {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_IDENTITY_INVALID",
      "Commit-readiness identity must be a plain object",
    );
  }
  const c = candidate as FeedWorkspaceHostCandidateActivationReadinessIdentity;
  if (c.phase !== "3B.3.42") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_IDENTITY_PHASE",
      "phase must be 3B.3.42",
    );
  }
  if (
    ...
    c.activationIssuancePipelineExecutionId !==
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ID ||
    c.activationCandidateActivationReadinessId !==
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ID ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_IDENTITY_CHAIN",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_IDENTITY_TRANSFER",
