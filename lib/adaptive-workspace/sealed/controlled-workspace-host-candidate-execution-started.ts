 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.46 candidate activation state to declare
 * candidate-activation metadata. Records candidateActivationStarted metadata only (absent→true). Does not execute the candidate, unlock Allowed/Executable, or render Workspace.
 */
...
} from "./controlled-workspace-host-candidate-activation-readiness";
import {
...
} from "./controlled-workspace-host-candidate-activation-authorization";
import {
...
import {
  ...
  evaluateControlledWorkspaceHostCandidateExecutable as evaluatePredecessorCandidateExecutable,
} from "./controlled-workspace-host-candidate-executable";
import {
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_47_CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_ONLY =
  "PHASE_3B3_47_CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_ID =
  "feed.discovery.adaptive-workspace.host-candidate-execution-started.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-candidate-execution-started.contract.v1" as const;


export type ControlledWorkspaceHostCandidateExecutionStartedState =
  | "CANDIDATE_EXECUTION_STARTED_NOT_EXECUTED"
  | "BLOCKED";

export type ControlledWorkspaceHostCandidateExecutionStartedResult =
  | "controlled-workspace-host-candidate-execution-started-not-executed"
  | "controlled-workspace-host-candidate-execution-started-blocked-missing-readiness"
  | "controlled-workspace-host-candidate-execution-started-blocked-missing-authorization"
  | "controlled-workspace-host-candidate-execution-started-blocked-duplicate-activation"
  | "controlled-workspace-host-candidate-execution-started-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-candidate-execution-started-blocked-missing-preparation-authorization"
  | "controlled-workspace-host-candidate-execution-started-blocked-duplicate-preparation"
  | "controlled-workspace-host-candidate-execution-started-blocked-invalid-predecessor"
  | "controlled-workspace-host-candidate-execution-started-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-candidate-execution-started-blocked-invalid-readiness"
  | "controlled-workspace-host-candidate-execution-started-blocked-invalid-selection"
  | "controlled-workspace-host-candidate-execution-started-blocked-invalid-candidate"
  | "controlled-workspace-host-candidate-execution-started-blocked-invalid-contract"
  | "controlled-workspace-host-candidate-execution-started-blocked-duplicate-commit-readiness"
  | "controlled-workspace-host-candidate-execution-started-blocked-duplicate-commit"
  | "controlled-workspace-host-candidate-execution-started-blocked-missing-commit-readiness"
  | "controlled-workspace-host-candidate-execution-started-blocked-missing-commit-authorization"
  | "controlled-workspace-host-candidate-execution-started-blocked-duplicate-entry"
  | "controlled-workspace-host-candidate-execution-started-blocked-boundary-executable"
  | "controlled-workspace-host-candidate-execution-started-blocked-runtime-capability"
  | "controlled-workspace-host-candidate-execution-started-blocked-runtime-host"
  | "controlled-workspace-host-candidate-execution-started-blocked-activation-handle"
  | "controlled-workspace-host-candidate-execution-started-blocked-workspace-render"
  | "controlled-workspace-host-candidate-execution-started-blocked-second-geofeed"
  | "controlled-workspace-host-candidate-execution-started-blocked-runtime-mutation"
  | "controlled-workspace-host-candidate-execution-started-blocked-shell"
  | "controlled-workspace-host-candidate-execution-started-blocked-ownership"
  | "controlled-workspace-host-candidate-execution-started-blocked-renderer"
  | "controlled-workspace-host-candidate-execution-started-blocked-writer"
  | "controlled-workspace-host-candidate-execution-started-blocked-pipeline"
  | "controlled-workspace-host-candidate-execution-started-blocked-transaction"
  | "controlled-workspace-host-candidate-execution-started-blocked-armed"
  | "controlled-workspace-host-candidate-execution-started-blocked-crossed"
  | "controlled-workspace-host-candidate-execution-started-blocked-committed"
  | "controlled-workspace-host-candidate-execution-started-blocked-aborted"
  | "controlled-workspace-host-candidate-execution-started-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostCandidateActivationRecord = {
  ...
  readonly activationIssuancePipelineExecutionId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ID;
  readonly activationIssuancePipelineExecutionContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONTRACT_ID;
  readonly activationCandidateActivationReadinessId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ID;
  readonly activationCandidateActivationReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_ID;
  readonly activationCandidateActivationAuthorizationId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ID;
  readonly activationCandidateActivationAuthorizationContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_ID;
  readonly activationCandidateActivationId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ID;
  readonly activationCandidateActiveId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ID;
  readonly activationCandidateExecutableId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ID;
  readonly activationCandidateExecutionStartedId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_ID;
  readonly activationCandidateActivationContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_ID;
  readonly activationCandidateActiveContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONTRACT_ID;
  readonly activationCandidateExecutableContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONTRACT_ID;
  ...
  readonly candidateActivationReadinessAllowed: false;
...
export type ControlledWorkspaceHostCandidateExecutionStartedDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_SCHEMA_VERSION;
  readonly phase: "3B.3.47";
  readonly previousPhase: "3B.3.46";
  readonly currentPhase: "3B.3.47";
  readonly nextEligibleStep: "3B.3.48";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly candidateActivationState: "CANDIDATE_EXECUTION_STARTED_NOT_EXECUTED";
  readonly candidateActivationResult: "controlled-workspace-host-candidate-execution-started-not-executed";
  ...
  readonly issuancePipelineExecuted: true;
  readonly candidateActivationReady: true;
  readonly candidateActivationAuthorized: true;
  ...
  readonly candidateActivated: true;
  readonly candidateActive: true;
  readonly candidateExecutable: true;
  ...
  readonly activatedCandidateCount: 1;
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionCommitRecords: readonly [ControlledWorkspaceHostCandidateActivationRecord];
  ...
  readonly predecessorActivationIssuancePipelineExecutionAuthorizationResult: "controlled-workspace-host-activation-issuance-pipeline-execution-authorized-not-executed";
  readonly predecessorActivationIssuancePipelineExecutionAuthorizationState: "PIPELINE_EXECUTION_AUTHORIZED_NOT_EXECUTED";
  readonly predecessorActivationIssuancePipelineExecutionResult: "controlled-workspace-host-activation-issuance-pipeline-executed-not-activated";
  readonly predecessorActivationIssuancePipelineExecutionState: "PIPELINE_EXECUTED_NOT_ACTIVATED";
  ...
  readonly activationBlocker: typeof PHASE_3B3_47_CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostCandidateExecutionStartedDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostCandidateExecutionStartedEvaluation = {
  readonly descriptor: ControlledWorkspaceHostCandidateExecutionStartedDescriptor;
  readonly diagnostics: ControlledWorkspaceHostCandidateExecutionStartedDiagnostics;
};

export type ControlledWorkspaceHostCandidateExecutionStartedInput = {
  readonly entry?: Partial<ControlledWorkspaceHostCandidateActivationRecord> &
  ...
  readonly candidateActivationReady?: boolean;
  readonly candidateActivationAuthorized?: boolean;
  readonly candidateGranted?: boolean;
  readonly candidateActivated?: boolean;
  readonly candidateActive?: boolean;
  readonly candidateExecutable?: boolean;
  readonly candidateActivationStarted?: boolean;
  readonly candidateActivationExecuted?: boolean;
  readonly candidateActivationCompleted?: boolean;
...
function createCommitRecord(): ControlledWorkspaceHostCandidateActivationRecord {
  return Object.freeze({
    ...
    activationIssuancePipelineExecutionContractId:
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONTRACT_ID,
    activationCandidateActivationReadinessId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ID,
    activationCandidateActivationReadinessContractId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_ID,
    activationCandidateActivationAuthorizationId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ID,
    activationCandidateActivationAuthorizationContractId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_ID,
    activationCandidateActivationId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ID,
    activationCandidateActivationContractId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_ID,
    activationCandidateActiveId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ID,
    activationCandidateActiveContractId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONTRACT_ID,
    activationCandidateExecutableId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ID,
    activationCandidateExecutableContractId:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONTRACT_ID,
    ...
    candidateActivationReadinessAllowed: false,
...
function blockedResultFor(
  input: ControlledWorkspaceHostCandidateExecutionStartedInput | undefined,
): ControlledWorkspaceHostCandidateExecutionStartedResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-execution-started-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-invalid-predecessor";
  }
  if (input.candidateActive === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-invalid-predecessor";
  }
  if (input.candidateExecutable === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-invalid-predecessor";
  }
  if (Object.prototype.hasOwnProperty.call(input, "candidateActivationStarted")) {
    return "controlled-workspace-host-candidate-execution-started-blocked-duplicate-activation";
  }
  if (Object.prototype.hasOwnProperty.call(input, "candidateActivationExecuted")) {
    return "controlled-workspace-host-candidate-execution-started-blocked-illegal-transition";
  }
  if (Object.prototype.hasOwnProperty.call(input, "candidateActivationCompleted")) {
    return "controlled-workspace-host-candidate-execution-started-blocked-illegal-transition";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-execution-started-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-candidate-execution-started-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionAllowed === true) {
    return "controlled-workspace-host-candidate-execution-started-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionReady === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-readiness";
  }
  if (input.issuancePipelineStarted === true) {
    return "controlled-workspace-host-candidate-execution-started-blocked-pipeline";
  }
  if (input.issuancePipelineExecuted === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-invalid-predecessor";
  }
  if (input.candidateActivationReady === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-readiness";
  }
  if (input.candidateActivationAuthorized === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-authorization";
  }
  ...
  if (input.transactionCommitReady === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-commit-readiness";
  }
  if (input.transactionCommitAuthorized === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-commit-authorization";
  }
  if (input.issuancePipelineExecutionAuthorized === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-authorization";
  }
  ...
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === false) {
    return "controlled-workspace-host-candidate-execution-started-blocked-missing-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-candidate-execution-started-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-candidate-execution-started-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-candidate-execution-started-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-candidate-execution-started-blocked-aborted";
  }
  ...
  if (input.candidates && input.candidates.length !== 1) {
    return "controlled-workspace-host-candidate-execution-started-blocked-invalid-candidate";
  }
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-candidate-execution-started-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-candidate-execution-started-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-execution-started-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-candidate-execution-started-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-candidate-execution-started-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-candidate-execution-started-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-candidate-execution-started-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-candidate-execution-started-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-execution-started-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-candidate-execution-started-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-execution-started-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-execution-started-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-candidate-execution-started-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-candidate-execution-started-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-candidate-execution-started-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostCandidateExecutionStartedDescriptor(): ControlledWorkspaceHostCandidateExecutionStartedDescriptor {
  const record = createCommitRecord();
  return validateControlledWorkspaceHostCandidateExecutionStartedDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_SCHEMA_VERSION,
      phase: "3B.3.47",
      previousPhase: "3B.3.46",
      currentPhase: "3B.3.47",
      ...
      activationBlocker:
        PHASE_3B3_47_CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostCandidateExecutionStartedDescriptor(
  d: ControlledWorkspaceHostCandidateExecutionStartedDescriptor,
): ControlledWorkspaceHostCandidateExecutionStartedDescriptor {
  if (
    d.phase !== "3B.3.47" ||
    d.previousPhase !== "3B.3.46" ||
    d.currentPhase !== "3B.3.47" ||
    d.nextEligibleStep !== "3B.3.48"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_PHASE",
      "Phase chain must be 3B.3.46 → 3B.3.47 → 3B.3.48",
    );
  }
  if (
    d.candidateActivationState !== "CANDIDATE_EXECUTION_STARTED_NOT_EXECUTED" ||
    d.candidateActivationResult !==
      "controlled-workspace-host-candidate-execution-started-not-executed"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_RESULT",
      "Successful candidate activation must be CANDIDATE_EXECUTION_STARTED_NOT_EXECUTED",
    );
  }
  if (
    ...
    d.activationTransactionCommitId !==
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_ID ||
    d.activationIssuancePipelineExecutionReadinessId !==
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_READINESS_ID ||
    d.activationIssuancePipelineExecutionAuthorizationId !==
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_ID ||
    d.activationCandidateActivationReadinessId !==
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ID ||
    d.activationCandidateActivationAuthorizationId !==
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ID ||
    d.activationCandidateActivationId !==
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ID ||
    d.activationCandidateActiveId !==
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ID ||
    d.activationCandidateExecutableId !==
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ID ||
    d.activationCandidateExecutionStartedId !==
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_ID
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_IDENTITY",
  ...
  if (
    ...
    d.issuancePipelineExecuted !== true ||
    d.candidateActivationReady !== true ||
    d.candidateActivationAuthorized !== true ||
    d.issuanceTransactionAborted !== false
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_FLAGS",
      "Candidate activation authorization requires readiness preserved and authorization advanced with OPENED committed=true aborted=false",
    );
  }
  if (
    d.candidateCount !== 1 ||
    ...
    Object.prototype.hasOwnProperty.call(d, "candidateActivationExecuted") ||
    Object.prototype.hasOwnProperty.call(d, "candidateActivationCompleted") ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_COUNTS",
      "Executable candidate must remain non-executed (pipeline NON_EXECUTABLE, live gate closed), with exactly one commit-boundary entry",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_TRANSITION",
  ...
  if (
    ...
    d.issuancePipelineExecutionAuthorized !== true ||
    d.issuancePipelineExecuted !== true ||
    d.predecessorActivationIssuancePipelineExecutionAuthorizationState !==
      "PIPELINE_EXECUTION_AUTHORIZED_NOT_EXECUTED" ||
    d.predecessorActivationIssuancePipelineExecutionAuthorizationResult !==
      "controlled-workspace-host-activation-issuance-pipeline-execution-authorized-not-executed"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_RUNTIME",
...
export function evaluateControlledWorkspaceHostCandidateExecutionStarted(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostCandidateExecutionStartedInput,
): ControlledWorkspaceHostCandidateExecutionStartedEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_REGISTRY",
      "Candidate activation authorization requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluatePredecessorCandidateExecutable(registry);
  ...
  if (
    ...
    pred.candidateActivationState !== "CANDIDATE_EXECUTABLE_NOT_EXECUTED" ||
    pred.candidateActivationReady !== true ||
    pred.candidateActivationAuthorized !== true ||
    pred.candidateActivated !== true ||
    pred.candidateActive !== true ||
    pred.candidateExecutable !== true ||
    Object.prototype.hasOwnProperty.call(pred, "candidateActivationStarted") ||
    ...
    pred.issuancePipelineExecuted !== true ||
    pred.issuancePipelineExecutionReady !== true ||
    pred.issuancePipelineExecutionAuthorized !== true ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_PREDECESSOR_LIVE",
      "Predecessor candidate executable must remain EXECUTABLE_NOT_EXECUTED with Started/Executed/Completed absent and NON_EXECUTABLE pipeline",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_BLOCKED",
      blocked,
    );
  }
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningAllowed: false,
      activationExecutionAllowed: false,
      candidateActivationResult: descriptor.candidateActivationResult,
      candidateActivationState: descriptor.candidateActivationState,
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_BLOCKERS,
