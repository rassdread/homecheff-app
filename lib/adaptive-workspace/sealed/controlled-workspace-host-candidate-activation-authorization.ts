 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.42 candidate-activation readiness state to declare
 * candidate-activation authorization metadata. Does not activate the candidate,
 * unlock Allowed/Executable, or render Workspace.
 */
...
import {
  ...
  evaluateControlledWorkspaceHostCandidateActivationReadiness as evaluatePredecessorCandidateActivationReadiness,
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_43_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ONLY =
  "PHASE_3B3_43_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ID =
  "feed.discovery.adaptive-workspace.host-candidate-activation-authorization.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-candidate-activation-authorization.contract.v1" as const;


export type ControlledWorkspaceHostCandidateActivationAuthorizationState =
  | "CANDIDATE_ACTIVATION_AUTHORIZED_NOT_ACTIVATED"
  | "BLOCKED";

export type ControlledWorkspaceHostCandidateActivationAuthorizationResult =
  | "controlled-workspace-host-candidate-activation-authorized-not-activated"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-missing-readiness"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-missing-authorization"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-duplicate-authorization"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-missing-preparation-authorization"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-duplicate-preparation"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-predecessor"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-readiness"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-selection"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-candidate"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-contract"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-duplicate-commit-readiness"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-duplicate-commit"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-missing-commit-readiness"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-missing-commit-authorization"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-duplicate-entry"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-boundary-executable"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-runtime-capability"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-runtime-host"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-activation-handle"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-workspace-render"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-second-geofeed"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-runtime-mutation"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-shell"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-ownership"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-renderer"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-writer"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-pipeline"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-transaction"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-armed"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-crossed"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-committed"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-aborted"
  | "controlled-workspace-host-candidate-activation-authorization-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostCandidateActivationAuthorizationRecord = {
...
export type ControlledWorkspaceHostCandidateActivationAuthorizationDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_SCHEMA_VERSION;
  readonly phase: "3B.3.43";
  readonly previousPhase: "3B.3.42";
  readonly currentPhase: "3B.3.43";
  readonly nextEligibleStep: "3B.3.44";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly candidateActivationAuthorizationState: "CANDIDATE_ACTIVATION_AUTHORIZED_NOT_ACTIVATED";
  readonly candidateActivationAuthorizationResult: "controlled-workspace-host-candidate-activation-authorized-not-activated";
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionCommitRecords: readonly [ControlledWorkspaceHostCandidateActivationAuthorizationRecord];
  ...
  readonly activationBlocker: typeof PHASE_3B3_43_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostCandidateActivationAuthorizationDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostCandidateActivationAuthorizationEvaluation = {
  readonly descriptor: ControlledWorkspaceHostCandidateActivationAuthorizationDescriptor;
  readonly diagnostics: ControlledWorkspaceHostCandidateActivationAuthorizationDiagnostics;
};

export type ControlledWorkspaceHostCandidateActivationAuthorizationInput = {
  readonly entry?: Partial<ControlledWorkspaceHostCandidateActivationAuthorizationRecord> &
...
function createCommitRecord(): ControlledWorkspaceHostCandidateActivationAuthorizationRecord {
...
function blockedResultFor(
  input: ControlledWorkspaceHostCandidateActivationAuthorizationInput | undefined,
): ControlledWorkspaceHostCandidateActivationAuthorizationResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-candidate";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-authorization-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionAllowed === true) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionReady === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-missing-readiness";
  }
  ...
  if (input.candidateActivationAuthorized === true) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-duplicate-authorization";
  }
  ...
  if (input.transactionCommitReady === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-missing-commit-readiness";
  }
  if (input.transactionCommitAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-missing-commit-authorization";
  }
  if (input.issuancePipelineExecutionAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-missing-authorization";
  }
  if (input.transactionOpeningReady === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-missing-readiness";
  }
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-missing-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-authorization-blocked-illegal-transition";
  }
  ...
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-candidate-activation-authorization-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-candidate-activation-authorization-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-candidate-activation-authorization-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-candidate-activation-authorization-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-candidate-activation-authorization-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-activation-authorization-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-candidate-activation-authorization-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-activation-authorization-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-activation-authorization-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-candidate-activation-authorization-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostCandidateActivationAuthorizationDescriptor(): ControlledWorkspaceHostCandidateActivationAuthorizationDescriptor {
  const record = createCommitRecord();
  return validateControlledWorkspaceHostCandidateActivationAuthorizationDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_SCHEMA_VERSION,
      phase: "3B.3.43",
      previousPhase: "3B.3.42",
      currentPhase: "3B.3.43",
    ...
    activationCandidateActivationAuthorizationId:
      ...
      activationBlocker:
        PHASE_3B3_43_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostCandidateActivationAuthorizationDescriptor(
  d: ControlledWorkspaceHostCandidateActivationAuthorizationDescriptor,
): ControlledWorkspaceHostCandidateActivationAuthorizationDescriptor {
  if (
    d.phase !== "3B.3.43" ||
    d.previousPhase !== "3B.3.42" ||
    d.currentPhase !== "3B.3.43" ||
    d.nextEligibleStep !== "3B.3.44"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_PHASE",
      "Phase chain must be 3B.3.41 → 3B.3.43 → 3B.3.43",
    );
  }
  if (
    d.candidateActivationAuthorizationState !== "CANDIDATE_ACTIVATION_AUTHORIZED_NOT_ACTIVATED" ||
    d.candidateActivationAuthorizationResult !==
      "controlled-workspace-host-candidate-activation-authorized-not-activated"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_RESULT",
      "Successful candidate activation authorization must be CANDIDATE_ACTIVATION_AUTHORIZED_NOT_ACTIVATED",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_IDENTITY",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_FLAGS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_TRANSITION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_RUNTIME",
...
export function evaluateControlledWorkspaceHostCandidateActivationAuthorization(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostCandidateActivationAuthorizationInput,
): ControlledWorkspaceHostCandidateActivationAuthorizationEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_REGISTRY",
      "Candidate activation authorization requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluatePredecessorCandidateActivationReadiness(registry);
  const pred = predecessor.descriptor;

  if (
    pred.candidateActivationReadinessResult !==
      "controlled-workspace-host-candidate-activation-ready-not-activated" ||
    pred.candidateActivationReadinessState !== "CANDIDATE_ACTIVATION_READY_NOT_ACTIVATED" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_PREDECESSOR_LIVE",
      "Predecessor issuance-pipeline-execution must remain EXECUTED_NOT_ACTIVATED with transaction OPENED prepared committed and NON_EXECUTABLE pipeline",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_BLOCKED",
      blocked,
    );
  }
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningAllowed: false,
      activationExecutionAllowed: false,
      candidateActivationAuthorizationResult: descriptor.candidateActivationAuthorizationResult,
      candidateActivationAuthorizationState: descriptor.candidateActivationAuthorizationState,
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_BLOCKERS,
