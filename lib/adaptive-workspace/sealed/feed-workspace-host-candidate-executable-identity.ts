/**
 * Phase 3B.3.46 — Workspace host activation candidate-activation identity contract.
 */
...
export const FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_IDENTITY_SCHEMA_VERSION =
  1 as const;

export type FeedWorkspaceHostCandidateExecutableIdentity = {
  schemaVersion: typeof FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_IDENTITY_SCHEMA_VERSION;
  phase: "3B.3.46";
...
export function createFeedWorkspaceHostCandidateExecutableIdentity(): FeedWorkspaceHostCandidateExecutableIdentity {
  return validateFeedWorkspaceHostCandidateExecutableIdentity({
    schemaVersion:
      FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_IDENTITY_SCHEMA_VERSION,
    phase: "3B.3.46",
...
export function validateFeedWorkspaceHostCandidateExecutableIdentity(
  candidate: unknown,
): FeedWorkspaceHostCandidateExecutableIdentity {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_IDENTITY_INVALID",
      "Commit-readiness identity must be a plain object",
    );
  }
  const c = candidate as FeedWorkspaceHostCandidateExecutableIdentity;
  if (c.phase !== "3B.3.46") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_IDENTITY_PHASE",
      "phase must be 3B.3.46",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_IDENTITY_CHAIN",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_IDENTITY_TRANSFER",
