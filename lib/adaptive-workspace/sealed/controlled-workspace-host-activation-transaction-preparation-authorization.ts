 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.33 preparation-ready state to authorize preparation
 * for a future issuance-transaction preparation. Does not prepare, commit, or abort
 * the transaction, and does not make the issuance pipeline executable.
 */
...
import {
  ...
  evaluateControlledWorkspaceHostActivationTransactionPreparationReadiness as evaluatePredecessorPreparationReadiness,
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_34_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_ONLY =
  "PHASE_3B3_34_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-preparation-authorization.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-preparation-authorization.contract.v1" as const;


export type ControlledWorkspaceHostActivationTransactionPreparationAuthorizationState =
  | "TRANSACTION_PREPARATION_AUTHORIZED_NOT_PREPARED"
  | "BLOCKED";

export type ControlledWorkspaceHostActivationTransactionPreparationAuthorizationResult =
  | "controlled-workspace-host-activation-transaction-preparation-authorized-not-prepared"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-missing-readiness"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-duplicate-preparation-authorization"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-predecessor"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-readiness"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-selection"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-candidate"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-contract"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-duplicate-entry"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-boundary-executable"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-runtime-capability"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-runtime-host"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-activation-handle"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-workspace-render"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-second-geofeed"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-runtime-mutation"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-shell"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-ownership"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-renderer"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-writer"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-pipeline"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-transaction"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-armed"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-crossed"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-committed"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-aborted"
  | "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
    "previous-phase-3b333-complete",
    "next-eligible-step-3b335",
    "transaction-preparation-authorization-result-exact",
    "transaction-preparation-authorization-state-exact",
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostActivationTransactionPreparationAuthorizationRecord = {
...
export type ControlledWorkspaceHostActivationTransactionPreparationAuthorizationDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_SCHEMA_VERSION;
  readonly phase: "3B.3.34";
  readonly previousPhase: "3B.3.33";
  readonly currentPhase: "3B.3.34";
  readonly nextEligibleStep: "3B.3.35";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly transactionPreparationAuthorizationState: "TRANSACTION_PREPARATION_AUTHORIZED_NOT_PREPARED";
  readonly transactionPreparationAuthorizationResult: "controlled-workspace-host-activation-transaction-preparation-authorized-not-prepared";
  ...
  readonly transactionPreparationAuthorizationCount: 1;
  ...
  readonly duplicateTransactionPreparationAuthorizationCount: 0;
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionPreparationAuthorizationRecords: readonly [ControlledWorkspaceHostActivationTransactionPreparationAuthorizationRecord];
  readonly predecessorActivationTransactionPreparationReadinessResult: "controlled-workspace-host-activation-transaction-preparation-ready-not-prepared";
  readonly predecessorActivationTransactionPreparationReadinessState: "TRANSACTION_PREPARATION_READY_NOT_PREPARED";
  ...
  readonly activationBlocker: typeof PHASE_3B3_34_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostActivationTransactionPreparationAuthorizationDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostActivationTransactionPreparationAuthorizationEvaluation = {
  readonly descriptor: ControlledWorkspaceHostActivationTransactionPreparationAuthorizationDescriptor;
  readonly diagnostics: ControlledWorkspaceHostActivationTransactionPreparationAuthorizationDiagnostics;
};

export type ControlledWorkspaceHostActivationTransactionPreparationAuthorizationInput = {
  readonly entry?: Partial<ControlledWorkspaceHostActivationTransactionPreparationAuthorizationRecord> &
...
function createPreparationAuthorizationRecord(): ControlledWorkspaceHostActivationTransactionPreparationAuthorizationRecord {
...
function blockedResultFor(
  input: ControlledWorkspaceHostActivationTransactionPreparationAuthorizationInput | undefined,
): ControlledWorkspaceHostActivationTransactionPreparationAuthorizationResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-candidate";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-pipeline";
  }
  ...
  if (input.transactionOpeningReady === false) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-missing-readiness";
  }
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === true) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-duplicate-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-illegal-transition";
  }
  ...
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-preparation-authorization-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostActivationTransactionPreparationAuthorizationDescriptor(): ControlledWorkspaceHostActivationTransactionPreparationAuthorizationDescriptor {
  const record = createPreparationAuthorizationRecord();
  return validateControlledWorkspaceHostActivationTransactionPreparationAuthorizationDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_SCHEMA_VERSION,
      phase: "3B.3.34",
      previousPhase: "3B.3.33",
      currentPhase: "3B.3.34",
      ...
      certificatePresent: false,
      permitPresent: false,
      transactionPreparationAuthorizationRecords: [record],
      ...
      activationBlocker:
        PHASE_3B3_34_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostActivationTransactionPreparationAuthorizationDescriptor(
  d: ControlledWorkspaceHostActivationTransactionPreparationAuthorizationDescriptor,
): ControlledWorkspaceHostActivationTransactionPreparationAuthorizationDescriptor {
  if (
    d.phase !== "3B.3.34" ||
    d.previousPhase !== "3B.3.33" ||
    d.currentPhase !== "3B.3.34" ||
    d.nextEligibleStep !== "3B.3.35"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_PHASE",
      "Phase chain must be 3B.3.32 → 3B.3.33 → 3B.3.34",
    );
  }
  if (
    d.transactionPreparationAuthorizationState !== "TRANSACTION_PREPARATION_AUTHORIZED_NOT_PREPARED" ||
    d.transactionPreparationAuthorizationResult !==
      "controlled-workspace-host-activation-transaction-preparation-authorized-not-prepared"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_RESULT",
      "Successful authorization must be TRANSACTION_PREPARATION_AUTHORIZED_NOT_PREPARED",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_IDENTITY",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_FLAGS",
      "Preparation authorization requires opening completed, transactionPreparationReady=true, authorized=true, transaction OPENED not prepared/committed/aborted",
    );
  }
  if (
    d.candidateCount !== 1 ||
    ...
    d.grantCount !== 1 ||
    d.transactionPreparationAuthorizationCount !== 1 ||
    d.duplicateTransactionPreparationAuthorizationCount !== 0 ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_TRANSITION",
      "Only the legal NOT_ENTERED → ENTERED transition may be recorded",
    );
  }
  if (
    d.predecessorActivationTransactionPreparationReadinessState !== "TRANSACTION_PREPARATION_READY_NOT_PREPARED" ||
    d.predecessorActivationTransactionPreparationReadinessResult !==
      "controlled-workspace-host-activation-transaction-preparation-ready-not-prepared" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_RUNTIME",
...
export function evaluateControlledWorkspaceHostActivationTransactionPreparationAuthorization(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostActivationTransactionPreparationAuthorizationInput,
): ControlledWorkspaceHostActivationTransactionPreparationAuthorizationEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_REGISTRY",
      "Transaction-opening requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluatePredecessorPreparationReadiness(registry);
  const pred = predecessor.descriptor;

  if (
    pred.transactionPreparationReadinessResult !==
      "controlled-workspace-host-activation-transaction-preparation-ready-not-prepared" ||
    pred.transactionPreparationReadinessState !== "TRANSACTION_PREPARATION_READY_NOT_PREPARED" ||
    ...
    pred.transactionPreparationAuthorized !== false ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_PREDECESSOR_LIVE",
      "Predecessor preparation-readiness must remain READY_NOT_PREPARED with authorized=false and transaction OPENED unprepared",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_BLOCKED",
      blocked,
    );
  }
  ...
  const record = descriptor.transactionPreparationAuthorizationRecords[0];
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningAllowed: false,
      activationExecutionAllowed: false,
      transactionPreparationAuthorizationResult: descriptor.transactionPreparationAuthorizationResult,
      transactionPreparationAuthorizationState: descriptor.transactionPreparationAuthorizationState,
      ...
      activationTransactionPreparationAuthorizationId: record.activationTransactionPreparationAuthorizationId,
      activationTransactionPreparationAuthorizationContractId:
        record.activationTransactionPreparationAuthorizationContractId,
      runtimeCapabilityPresent: false,
      runtimeHostInstancePresent: false,
      activationHandlePresent: false,
      executionHandlePresent: false,
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_AUTHORIZATION_BLOCKERS,
      transactionPreparationAuthorizationRecords: descriptor.transactionPreparationAuthorizationRecords,
    },
  };
}
