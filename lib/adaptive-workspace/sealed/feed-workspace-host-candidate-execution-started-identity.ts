/**
 * Phase 3B.3.47 — Workspace host activation candidate-activation identity contract.
 */
...
export const FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_IDENTITY_SCHEMA_VERSION =
  1 as const;

export type FeedWorkspaceHostCandidateExecutionStartedIdentity = {
  schemaVersion: typeof FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_IDENTITY_SCHEMA_VERSION;
  phase: "3B.3.47";
  ...
  activationCandidateActiveId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ID;
  activationCandidateActiveContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONTRACT_ID;
  activationCandidateExecutableId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_ID;
  activationCandidateExecutableContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTABLE_CONTRACT_ID;
  activationCandidateExecutionStartedId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_ID;
  activationCandidateExecutionStartedContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_CONTRACT_ID;
...
export function createFeedWorkspaceHostCandidateExecutionStartedIdentity(): FeedWorkspaceHostCandidateExecutionStartedIdentity {
  return validateFeedWorkspaceHostCandidateExecutionStartedIdentity({
    schemaVersion:
      FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_IDENTITY_SCHEMA_VERSION,
    phase: "3B.3.47",
...
export function validateFeedWorkspaceHostCandidateExecutionStartedIdentity(
  candidate: unknown,
): FeedWorkspaceHostCandidateExecutionStartedIdentity {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_IDENTITY_INVALID",
      "Commit-readiness identity must be a plain object",
    );
  }
  const c = candidate as FeedWorkspaceHostCandidateExecutionStartedIdentity;
  if (c.phase !== "3B.3.47") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_IDENTITY_PHASE",
      "phase must be 3B.3.47",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_IDENTITY_CHAIN",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_EXECUTION_STARTED_IDENTITY_TRANSFER",
