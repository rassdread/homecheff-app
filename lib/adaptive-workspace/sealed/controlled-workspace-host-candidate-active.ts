 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.44 candidate activation state to declare
 * candidate-activation metadata. Advances candidateActive metadata only. Does not set candidateExecutable, unlock Allowed/Executable, or render Workspace.
 */
...
import {
  ...
  evaluateControlledWorkspaceHostCandidateActivation as evaluatePredecessorCandidateActivation,
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_45_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ONLY =
  "PHASE_3B3_45_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ID =
  "feed.discovery.adaptive-workspace.host-candidate-active.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-candidate-active.contract.v1" as const;


export type ControlledWorkspaceHostCandidateActiveState =
  | "CANDIDATE_ACTIVE_NOT_EXECUTABLE"
  | "BLOCKED";

export type ControlledWorkspaceHostCandidateActiveResult =
  | "controlled-workspace-host-candidate-active-not-executable"
  | "controlled-workspace-host-candidate-active-blocked-missing-readiness"
  | "controlled-workspace-host-candidate-active-blocked-missing-authorization"
  | "controlled-workspace-host-candidate-active-blocked-duplicate-activation"
  | "controlled-workspace-host-candidate-active-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-candidate-active-blocked-missing-preparation-authorization"
  | "controlled-workspace-host-candidate-active-blocked-duplicate-preparation"
  | "controlled-workspace-host-candidate-active-blocked-invalid-predecessor"
  | "controlled-workspace-host-candidate-active-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-candidate-active-blocked-invalid-readiness"
  | "controlled-workspace-host-candidate-active-blocked-invalid-selection"
  | "controlled-workspace-host-candidate-active-blocked-invalid-candidate"
  | "controlled-workspace-host-candidate-active-blocked-invalid-contract"
  | "controlled-workspace-host-candidate-active-blocked-duplicate-commit-readiness"
  | "controlled-workspace-host-candidate-active-blocked-duplicate-commit"
  | "controlled-workspace-host-candidate-active-blocked-missing-commit-readiness"
  | "controlled-workspace-host-candidate-active-blocked-missing-commit-authorization"
  | "controlled-workspace-host-candidate-active-blocked-duplicate-entry"
  | "controlled-workspace-host-candidate-active-blocked-boundary-executable"
  | "controlled-workspace-host-candidate-active-blocked-runtime-capability"
  | "controlled-workspace-host-candidate-active-blocked-runtime-host"
  | "controlled-workspace-host-candidate-active-blocked-activation-handle"
  | "controlled-workspace-host-candidate-active-blocked-workspace-render"
  | "controlled-workspace-host-candidate-active-blocked-second-geofeed"
  | "controlled-workspace-host-candidate-active-blocked-runtime-mutation"
  | "controlled-workspace-host-candidate-active-blocked-shell"
  | "controlled-workspace-host-candidate-active-blocked-ownership"
  | "controlled-workspace-host-candidate-active-blocked-renderer"
  | "controlled-workspace-host-candidate-active-blocked-writer"
  | "controlled-workspace-host-candidate-active-blocked-pipeline"
  | "controlled-workspace-host-candidate-active-blocked-transaction"
  | "controlled-workspace-host-candidate-active-blocked-armed"
  | "controlled-workspace-host-candidate-active-blocked-crossed"
  | "controlled-workspace-host-candidate-active-blocked-committed"
  | "controlled-workspace-host-candidate-active-blocked-aborted"
  | "controlled-workspace-host-candidate-active-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostCandidateActiveDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_SCHEMA_VERSION;
  readonly phase: "3B.3.45";
  readonly previousPhase: "3B.3.44";
  readonly currentPhase: "3B.3.45";
  readonly nextEligibleStep: "3B.3.46";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly candidateActivationState: "CANDIDATE_ACTIVE_NOT_EXECUTABLE";
  readonly candidateActivationResult: "controlled-workspace-host-candidate-active-not-executable";
  ...
  readonly activationBlocker: typeof PHASE_3B3_45_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostCandidateActiveDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostCandidateActiveEvaluation = {
  readonly descriptor: ControlledWorkspaceHostCandidateActiveDescriptor;
  readonly diagnostics: ControlledWorkspaceHostCandidateActiveDiagnostics;
};

export type ControlledWorkspaceHostCandidateActiveInput = {
...
function blockedResultFor(
  input: ControlledWorkspaceHostCandidateActiveInput | undefined,
): ControlledWorkspaceHostCandidateActiveResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-active-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-candidate-active-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === false) {
    return "controlled-workspace-host-candidate-active-blocked-invalid-predecessor";
  }
  if (input.candidateActive === true) {
    return "controlled-workspace-host-candidate-active-blocked-duplicate-activation";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-active-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-candidate-active-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionAllowed === true) {
    return "controlled-workspace-host-candidate-active-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionReady === false) {
    return "controlled-workspace-host-candidate-active-blocked-missing-readiness";
  }
  ...
  if (input.candidateActivationAuthorized === false) {
    return "controlled-workspace-host-candidate-active-blocked-missing-authorization";
  }
  ...
  if (input.transactionCommitReady === false) {
    return "controlled-workspace-host-candidate-active-blocked-missing-commit-readiness";
  }
  if (input.transactionCommitAuthorized === false) {
    return "controlled-workspace-host-candidate-active-blocked-missing-commit-authorization";
  }
  ...
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-candidate-active-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-candidate-active-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === false) {
    return "controlled-workspace-host-candidate-active-blocked-missing-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-candidate-active-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-candidate-active-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-candidate-active-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-candidate-active-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-active-blocked-illegal-transition";
  }
  ...
  if (input.candidates && input.candidates.length !== 1) {
    return "controlled-workspace-host-candidate-active-blocked-invalid-candidate";
  }
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-candidate-active-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-candidate-active-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-active-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-candidate-active-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-candidate-active-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-candidate-active-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-candidate-active-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-candidate-active-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-active-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-candidate-active-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-active-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-active-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-candidate-active-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-candidate-active-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-candidate-active-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostCandidateActiveDescriptor(): ControlledWorkspaceHostCandidateActiveDescriptor {
  const record = createCommitRecord();
  return validateControlledWorkspaceHostCandidateActiveDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_SCHEMA_VERSION,
      phase: "3B.3.45",
      previousPhase: "3B.3.44",
      currentPhase: "3B.3.45",
      ...
      activationBlocker:
        PHASE_3B3_45_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostCandidateActiveDescriptor(
  d: ControlledWorkspaceHostCandidateActiveDescriptor,
): ControlledWorkspaceHostCandidateActiveDescriptor {
  if (
    d.phase !== "3B.3.45" ||
    d.previousPhase !== "3B.3.44" ||
    d.currentPhase !== "3B.3.45" ||
    d.nextEligibleStep !== "3B.3.46"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_PHASE",
      "Phase chain must be 3B.3.44 → 3B.3.45 → 3B.3.46",
    );
  }
  if (
    d.candidateActivationState !== "CANDIDATE_ACTIVE_NOT_EXECUTABLE" ||
    d.candidateActivationResult !==
      "controlled-workspace-host-candidate-active-not-executable"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_RESULT",
      "Successful candidate activation must be CANDIDATE_ACTIVE_NOT_EXECUTABLE",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_IDENTITY",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_FLAGS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_COUNTS",
      "Active candidate must remain non-executable, with exactly one commit-boundary entry",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_TRANSITION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_RUNTIME",
...
export function evaluateControlledWorkspaceHostCandidateActive(
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_PREDECESSOR_LIVE",
      "Predecessor candidate activation must remain ACTIVATED_NOT_ACTIVE with candidateActive=false and NON_EXECUTABLE pipeline",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVE_BLOCKED",
      blocked,
    );
  }
  ...
  return {
    ...
    diagnostics: {
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVE_BLOCKERS,
