 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.41 issuance-pipeline-executed state to declare
 * candidate-activation readiness metadata. Does not authorize or perform activation,
 * and does not unlock Allowed/Executable or render Workspace.
 */
...
import {
  ...
  evaluateControlledWorkspaceHostActivationIssuancePipelineExecution as evaluatePredecessorIssuancePipelineExecution,
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_42_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ONLY =
  "PHASE_3B3_42_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ID =
  "feed.discovery.adaptive-workspace.host-candidate-activation-readiness.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-candidate-activation-readiness.contract.v1" as const;


export type ControlledWorkspaceHostCandidateActivationReadinessState =
  | "CANDIDATE_ACTIVATION_READY_NOT_ACTIVATED"
  | "BLOCKED";

export type ControlledWorkspaceHostCandidateActivationReadinessResult =
  | "controlled-workspace-host-candidate-activation-ready-not-activated"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-missing-readiness"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-missing-preparation-authorization"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-duplicate-preparation"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-predecessor"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-readiness"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-selection"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-candidate"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-contract"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-duplicate-commit-readiness"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-duplicate-commit"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-missing-commit-readiness"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-missing-commit-authorization"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-duplicate-entry"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-boundary-executable"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-runtime-capability"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-runtime-host"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-activation-handle"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-workspace-render"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-second-geofeed"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-runtime-mutation"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-shell"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-ownership"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-renderer"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-writer"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-pipeline"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-transaction"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-armed"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-crossed"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-committed"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-aborted"
  | "controlled-workspace-host-candidate-activation-readiness-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostCandidateActivationReadinessRecord = {
...
export type ControlledWorkspaceHostCandidateActivationReadinessDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_SCHEMA_VERSION;
  readonly phase: "3B.3.42";
  readonly previousPhase: "3B.3.41";
  readonly currentPhase: "3B.3.42";
  readonly nextEligibleStep: "3B.3.43";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly candidateActivationReadinessState: "CANDIDATE_ACTIVATION_READY_NOT_ACTIVATED";
  readonly candidateActivationReadinessResult: "controlled-workspace-host-candidate-activation-ready-not-activated";
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionCommitRecords: readonly [ControlledWorkspaceHostCandidateActivationReadinessRecord];
  ...
  readonly activationBlocker: typeof PHASE_3B3_42_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostCandidateActivationReadinessDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostCandidateActivationReadinessEvaluation = {
  readonly descriptor: ControlledWorkspaceHostCandidateActivationReadinessDescriptor;
  readonly diagnostics: ControlledWorkspaceHostCandidateActivationReadinessDiagnostics;
};

export type ControlledWorkspaceHostCandidateActivationReadinessInput = {
  readonly entry?: Partial<ControlledWorkspaceHostCandidateActivationReadinessRecord> &
...
function createCommitRecord(): ControlledWorkspaceHostCandidateActivationReadinessRecord {
...
function blockedResultFor(
  input: ControlledWorkspaceHostCandidateActivationReadinessInput | undefined,
): ControlledWorkspaceHostCandidateActivationReadinessResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-candidate";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-readiness-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionAllowed === true) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionReady === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-missing-readiness";
  }
  ...
  if (input.candidateActivationReady === true) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-duplicate-readiness";
  }
  ...
  if (input.transactionCommitReady === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-missing-commit-readiness";
  }
  if (input.transactionCommitAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-missing-commit-authorization";
  }
  if (input.issuancePipelineExecutionAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-missing-authorization";
  }
  if (input.transactionOpeningReady === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-missing-readiness";
  }
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === false) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-missing-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-candidate-activation-readiness-blocked-illegal-transition";
  }
  ...
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-candidate-activation-readiness-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-candidate-activation-readiness-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-candidate-activation-readiness-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-candidate-activation-readiness-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-candidate-activation-readiness-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-candidate-activation-readiness-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-candidate-activation-readiness-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-activation-readiness-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-candidate-activation-readiness-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-candidate-activation-readiness-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostCandidateActivationReadinessDescriptor(): ControlledWorkspaceHostCandidateActivationReadinessDescriptor {
  const record = createCommitRecord();
  return validateControlledWorkspaceHostCandidateActivationReadinessDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_SCHEMA_VERSION,
      phase: "3B.3.42",
      previousPhase: "3B.3.41",
      currentPhase: "3B.3.42",
      ...
      activationBlocker:
        PHASE_3B3_42_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostCandidateActivationReadinessDescriptor(
  d: ControlledWorkspaceHostCandidateActivationReadinessDescriptor,
): ControlledWorkspaceHostCandidateActivationReadinessDescriptor {
  if (
    d.phase !== "3B.3.42" ||
    d.previousPhase !== "3B.3.41" ||
    d.currentPhase !== "3B.3.42" ||
    d.nextEligibleStep !== "3B.3.43"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_PHASE",
      "Phase chain must be 3B.3.41 → 3B.3.42 → 3B.3.43",
    );
  }
  if (
    d.candidateActivationReadinessState !== "CANDIDATE_ACTIVATION_READY_NOT_ACTIVATED" ||
    d.candidateActivationReadinessResult !==
      "controlled-workspace-host-candidate-activation-ready-not-activated"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_RESULT",
      "Successful candidate activation readiness must be CANDIDATE_ACTIVATION_READY_NOT_ACTIVATED",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_IDENTITY",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_FLAGS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_TRANSITION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_RUNTIME",
...
export function evaluateControlledWorkspaceHostCandidateActivationReadiness(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostCandidateActivationReadinessInput,
): ControlledWorkspaceHostCandidateActivationReadinessEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_REGISTRY",
      "Candidate activation readiness requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluatePredecessorIssuancePipelineExecution(registry);
  const pred = predecessor.descriptor;

  if (
    pred.pipelineExecutionResult !==
      "controlled-workspace-host-activation-issuance-pipeline-executed-not-activated" ||
    pred.pipelineExecutionState !== "PIPELINE_EXECUTED_NOT_ACTIVATED" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_PREDECESSOR_LIVE",
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_BLOCKED",
      blocked,
    );
  }
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningAllowed: false,
      activationExecutionAllowed: false,
      candidateActivationReadinessResult: descriptor.candidateActivationReadinessResult,
      candidateActivationReadinessState: descriptor.candidateActivationReadinessState,
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_BLOCKERS,
