 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.32 transaction-opened state to declare preparation readiness
 * for a future issuance-transaction preparation. Does not prepare, authorize preparation,
 * commit, or abort the transaction, and does not make the issuance pipeline executable.
 */
...
import {
  ...
  evaluateControlledWorkspaceHostActivationTransactionOpening as evaluatePredecessorTransactionOpening,
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_33_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_ONLY =
  "PHASE_3B3_33_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-preparation-readiness.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-activation-transaction-preparation-readiness.contract.v1" as const;


export type ControlledWorkspaceHostActivationTransactionPreparationReadinessState =
  | "TRANSACTION_PREPARATION_READY_NOT_PREPARED"
  | "BLOCKED";

export type ControlledWorkspaceHostActivationTransactionPreparationReadinessResult =
  | "controlled-workspace-host-activation-transaction-preparation-ready-not-prepared"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-missing-readiness"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-missing-authorization"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-duplicate-preparation-readiness"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-predecessor"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-readiness"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-selection"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-candidate"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-contract"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-duplicate-entry"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-boundary-executable"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-runtime-capability"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-runtime-host"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-activation-handle"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-workspace-render"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-second-geofeed"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-runtime-mutation"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-shell"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-ownership"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-renderer"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-writer"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-pipeline"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-transaction"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-armed"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-crossed"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-committed"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-aborted"
  | "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_CONDITIONS =
  Object.freeze([
    "phase-3b333-active",
    "previous-phase-3b332-complete",
    "next-eligible-step-3b334",
    "transaction-preparation-readiness-result-exact",
    "transaction-preparation-readiness-state-exact",
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostActivationTransactionPreparationReadinessRecord = {
...
export type ControlledWorkspaceHostActivationTransactionPreparationReadinessDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_SCHEMA_VERSION;
  readonly phase: "3B.3.33";
  readonly previousPhase: "3B.3.32";
  readonly currentPhase: "3B.3.33";
  readonly nextEligibleStep: "3B.3.34";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly transactionPreparationReadinessState: "TRANSACTION_PREPARATION_READY_NOT_PREPARED";
  readonly transactionPreparationReadinessResult: "controlled-workspace-host-activation-transaction-preparation-ready-not-prepared";
  ...
  readonly transactionPreparationAuthorized: false;
  ...
  readonly transactionPreparationReadinessCount: 1;
  ...
  readonly duplicateTransactionPreparationReadinessCount: 0;
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionPreparationReadinessRecords: readonly [ControlledWorkspaceHostActivationTransactionPreparationReadinessRecord];
  readonly predecessorActivationTransactionOpeningResult: "controlled-workspace-host-activation-transaction-opened-not-prepared";
  readonly predecessorActivationTransactionOpeningState: "TRANSACTION_OPENED_NOT_PREPARED";
  ...
  readonly activationBlocker: typeof PHASE_3B3_33_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostActivationTransactionPreparationReadinessDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostActivationTransactionPreparationReadinessEvaluation = {
  readonly descriptor: ControlledWorkspaceHostActivationTransactionPreparationReadinessDescriptor;
  readonly diagnostics: ControlledWorkspaceHostActivationTransactionPreparationReadinessDiagnostics;
};

export type ControlledWorkspaceHostActivationTransactionPreparationReadinessInput = {
  readonly entry?: Partial<ControlledWorkspaceHostActivationTransactionPreparationReadinessRecord> &
...
function createPreparationReadinessRecord(): ControlledWorkspaceHostActivationTransactionPreparationReadinessRecord {
...
function blockedResultFor(
  input: ControlledWorkspaceHostActivationTransactionPreparationReadinessInput | undefined,
): ControlledWorkspaceHostActivationTransactionPreparationReadinessResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-candidate";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-pipeline";
  }
  ...
  if (input.transactionOpeningReady === false) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-missing-readiness";
  }
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-missing-authorization";
  }
  if (input.transactionPreparationReady === true) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-duplicate-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === true) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-illegal-transition";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-aborted";
  }
  ...
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-activation-transaction-preparation-readiness-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostActivationTransactionPreparationReadinessDescriptor(): ControlledWorkspaceHostActivationTransactionPreparationReadinessDescriptor {
  const record = createPreparationReadinessRecord();
  return validateControlledWorkspaceHostActivationTransactionPreparationReadinessDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_SCHEMA_VERSION,
      phase: "3B.3.33",
      previousPhase: "3B.3.32",
      currentPhase: "3B.3.33",
      ...
      certificatePresent: false,
      permitPresent: false,
      transactionPreparationReadinessRecords: [record],
      ...
      activationBlocker:
        PHASE_3B3_33_CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostActivationTransactionPreparationReadinessDescriptor(
  d: ControlledWorkspaceHostActivationTransactionPreparationReadinessDescriptor,
): ControlledWorkspaceHostActivationTransactionPreparationReadinessDescriptor {
  if (
    d.phase !== "3B.3.33" ||
    d.previousPhase !== "3B.3.32" ||
    d.currentPhase !== "3B.3.33" ||
    d.nextEligibleStep !== "3B.3.34"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_PHASE",
      "Phase chain must be 3B.3.32 → 3B.3.33 → 3B.3.34",
    );
  }
  if (
    d.transactionPreparationReadinessState !== "TRANSACTION_PREPARATION_READY_NOT_PREPARED" ||
    d.transactionPreparationReadinessResult !==
      "controlled-workspace-host-activation-transaction-preparation-ready-not-prepared"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_RESULT",
      "Successful opening must be TRANSACTION_PREPARATION_READY_NOT_PREPARED",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_IDENTITY",
  ...
  if (
    ...
    d.transactionPreparationAuthorized !== false ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_FLAGS",
      "Preparation readiness requires opening completed, transactionPreparationReady=true, authorized=false, transaction OPENED not prepared/committed/aborted",
    );
  }
  if (
    d.candidateCount !== 1 ||
    ...
    d.grantCount !== 1 ||
    d.transactionPreparationReadinessCount !== 1 ||
    d.duplicateTransactionPreparationReadinessCount !== 0 ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_TRANSITION",
      "Only the legal NOT_ENTERED → ENTERED transition may be recorded",
    );
  }
  if (
    d.predecessorActivationTransactionOpeningState !== "TRANSACTION_OPENED_NOT_PREPARED" ||
    d.predecessorActivationTransactionOpeningResult !==
      "controlled-workspace-host-activation-transaction-opened-not-prepared" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_RUNTIME",
...
export function evaluateControlledWorkspaceHostActivationTransactionPreparationReadiness(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostActivationTransactionPreparationReadinessInput,
): ControlledWorkspaceHostActivationTransactionPreparationReadinessEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_REGISTRY",
      "Transaction-opening requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluatePredecessorTransactionOpening(registry);
  const pred = predecessor.descriptor;

  if (
    pred.transactionOpeningResult !==
      "controlled-workspace-host-activation-transaction-opened-not-prepared" ||
    pred.transactionOpeningState !== "TRANSACTION_OPENED_NOT_PREPARED" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_PREDECESSOR_LIVE",
      "Predecessor transaction-opening must remain OPENED_NOT_PREPARED with transaction OPENED and unprepared",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_BLOCKED",
      blocked,
    );
  }
  ...
  const record = descriptor.transactionPreparationReadinessRecords[0];
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningAllowed: false,
      activationExecutionAllowed: false,
      transactionPreparationReadinessResult: descriptor.transactionPreparationReadinessResult,
      transactionPreparationReadinessState: descriptor.transactionPreparationReadinessState,
      ...
      activationTransactionPreparationReadinessId: record.activationTransactionPreparationReadinessId,
      activationTransactionPreparationReadinessContractId:
        record.activationTransactionPreparationReadinessContractId,
      runtimeCapabilityPresent: false,
      runtimeHostInstancePresent: false,
      activationHandlePresent: false,
      executionHandlePresent: false,
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_PREPARATION_READINESS_BLOCKERS,
      transactionPreparationReadinessRecords: descriptor.transactionPreparationReadinessRecords,
    },
  };
}
