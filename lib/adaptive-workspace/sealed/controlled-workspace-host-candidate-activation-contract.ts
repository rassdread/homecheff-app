/**
 * Phase 3B.3.44 — Controlled Workspace Host Candidate Activation Contract.
 */
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_SCHEMA_VERSION =
  1 as const;

export type ControlledWorkspaceHostCandidateActivationContract = {
  schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_SCHEMA_VERSION;
  phase: "3B.3.44";
  ...
  contractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_ID;
  ...
  activationRestriction: typeof PHASE_3B3_44_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_ONLY;
  nextEligibleStep: "3B.3.45";
};

export function createControlledWorkspaceHostCandidateActivationContract(): ControlledWorkspaceHostCandidateActivationContract {
  return validateControlledWorkspaceHostCandidateActivationContract({
    schemaVersion:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_SCHEMA_VERSION,
    phase: "3B.3.44",
    previousPhase: "3B.3.43",
    widgetId: "feed.discovery",
    ...
    activationTransactionCommitId:
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_ID,
    contractId: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_ID,
...
export function validateControlledWorkspaceHostCandidateActivationContract(
  candidate: unknown,
): ControlledWorkspaceHostCandidateActivationContract {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_INVALID",
      "Transaction commit contract must be a plain object",
    );
  }
  const c = candidate as ControlledWorkspaceHostCandidateActivationContract;
  if (
    c.phase !== "3B.3.44" ||
    c.previousPhase !== "3B.3.43" ||
    c.nextEligibleStep !== "3B.3.45"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_PHASE",
      "phase must be 3B.3.44 with previousPhase 3B.3.43",
    );
  }
  if (
    c.candidateGranted !== true ||
    c.candidateActivated !== true ||
    c.candidateActive !== false ||
    c.grantPresent !== true ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_CONTRACT_FLAGS",
