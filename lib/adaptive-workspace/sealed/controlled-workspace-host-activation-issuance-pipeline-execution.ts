 ...
 * (metadata only).
 *
 * Consumes the frozen Phase 3B.3.40 execution-authorized state to declare sealed
 * issuance-pipeline-executed metadata. Does not run a runtime pipeline, does not
 * set execution Allowed/Executable, and does not activate the candidate or Workspace.
 */
...
import {
  ...
  evaluateControlledWorkspaceHostActivationIssuancePipelineExecutionAuthorization as evaluatePredecessorPipelineExecutionAuthorization,
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_SCHEMA_VERSION =
  1 as const;

export const PHASE_3B3_41_CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ONLY =
  "PHASE_3B3_41_CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ONLY" as const;



export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ID =
  "feed.discovery.adaptive-workspace.host-activation-issuance-pipeline-execution.v1" as const;

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONTRACT_ID =
  "feed.discovery.adaptive-workspace.host-activation-issuance-pipeline-execution.contract.v1" as const;


export type ControlledWorkspaceHostActivationIssuancePipelineExecutionState =
  | "PIPELINE_EXECUTED_NOT_ACTIVATED"
  | "BLOCKED";

export type ControlledWorkspaceHostActivationIssuancePipelineExecutionResult =
  | "controlled-workspace-host-activation-issuance-pipeline-executed-not-activated"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-readiness"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-preparation-readiness"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-preparation-authorization"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-duplicate-preparation"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-predecessor"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-grant-issuance"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-readiness"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-selection"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-candidate"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-contract"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-duplicate-commit-readiness"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-duplicate-commit"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-commit-readiness"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-commit-authorization"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-duplicate-entry"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-boundary-executable"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-runtime-capability"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-runtime-host"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-activation-handle"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-workspace-render"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-second-geofeed"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-runtime-mutation"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-shell"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-ownership"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-renderer"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-writer"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-pipeline"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-transaction"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-armed"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-crossed"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-committed"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-aborted"
  | "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-illegal-transition";

export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_BLOCKERS =
  Object.freeze([
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONDITIONS =
  Object.freeze([
    "phase-3b334-active",
...
export const CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_GUARDS =
  Object.freeze([
...
export type ControlledWorkspaceHostActivationIssuancePipelineExecutionRecord = {
...
export type ControlledWorkspaceHostActivationIssuancePipelineExecutionDescriptor = {
  readonly schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_SCHEMA_VERSION;
  readonly phase: "3B.3.41";
  readonly previousPhase: "3B.3.40";
  readonly currentPhase: "3B.3.41";
  readonly nextEligibleStep: "3B.3.42";
  readonly activationCommitBoundaryId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_ID;
  readonly activationCommitBoundaryContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_COMMIT_BOUNDARY_CONTRACT_ID;
  readonly activationTransactionOpeningReadinessId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_ID;
  readonly activationTransactionOpeningReadinessContractId: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_OPENING_READINESS_CONTRACT_ID;
  ...
  readonly pipelineExecutionState: "PIPELINE_EXECUTED_NOT_ACTIVATED";
  readonly pipelineExecutionResult: "controlled-workspace-host-activation-issuance-pipeline-executed-not-activated";
  ...
  readonly certificatePresent: false;
  readonly permitPresent: false;
  readonly transactionCommitRecords: readonly [ControlledWorkspaceHostActivationIssuancePipelineExecutionRecord];
  ...
  readonly activationBlocker: typeof PHASE_3B3_41_CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ONLY;
  readonly conditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONDITIONS;
  readonly satisfiedConditions: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONDITIONS;
  readonly unsatisfiedConditions: readonly [];
  readonly guards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_GUARDS;
  readonly satisfiedGuards: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_GUARDS;
  readonly unsatisfiedGuards: readonly [];
  readonly blockers: typeof CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_BLOCKERS;
  readonly browserInvariantIds: typeof FEED_SEALED_INVARIANT_IDS;
};

export type ControlledWorkspaceHostActivationIssuancePipelineExecutionDiagnostics = {
  readonly [key: string]: unknown;
};

export type ControlledWorkspaceHostActivationIssuancePipelineExecutionEvaluation = {
  readonly descriptor: ControlledWorkspaceHostActivationIssuancePipelineExecutionDescriptor;
  readonly diagnostics: ControlledWorkspaceHostActivationIssuancePipelineExecutionDiagnostics;
};

export type ControlledWorkspaceHostActivationIssuancePipelineExecutionInput = {
  readonly entry?: Partial<ControlledWorkspaceHostActivationIssuancePipelineExecutionRecord> &
...
function createCommitRecord(): ControlledWorkspaceHostActivationIssuancePipelineExecutionRecord {
...
function blockedResultFor(
  input: ControlledWorkspaceHostActivationIssuancePipelineExecutionInput | undefined,
): ControlledWorkspaceHostActivationIssuancePipelineExecutionResult | null {
  ...
  if (
    ...
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-predecessor";
  }
  if (
  ...
  if (input.candidateGranted === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-grant-issuance";
  }
  if (input.candidateActivated === true) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-candidate";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-transaction";
  }
  if (
  ...
  if (input.issuancePipelineExecutable === true) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionAllowed === true) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-pipeline";
  }
  if (input.issuancePipelineExecutionReady === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-readiness";
  }
  ...
  if (input.transactionCommitReady === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-commit-readiness";
  }
  if (input.transactionCommitAuthorized === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-commit-authorization";
  }
  if (input.issuancePipelineExecutionAuthorized === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-authorization";
  }
  if (input.issuancePipelineExecuted === true) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-duplicate-execution";
  }
  if (input.transactionOpeningReady === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-readiness";
  }
  if (input.transactionOpeningAuthorized === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationReady === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-preparation-readiness";
  }
  if (input.transactionPreparationAuthorized === false) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-missing-preparation-authorization";
  }
  if (
  ...
  if (input.activationCommitBoundaryArmed === true) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-armed";
  }
  if (input.activationCommitBoundaryCrossed === true) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-crossed";
  }
  if (input.activationCommitBoundaryCommitted === true) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-committed";
  }
  if (input.activationCommitBoundaryAborted === true) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-aborted";
  }
  ...
  if (
    ...
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-illegal-transition";
  }
  ...
  if (input.selections && input.selections.length !== 1) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-selection";
  }
  if (input.entryRecords && input.entryRecords.length !== 1) {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-duplicate-entry";
  }
  ...
  if (r) {
    ...
    if (
      ...
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-contract";
    }
    if (r.granted === false || r.grantPresent === false) {
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-invalid-grant-issuance";
    }
    if (r.grantExecutable === true) {
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-boundary-executable";
    }
    ...
    if (r.runtimeCapabilityPresent === true) {
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-runtime-capability";
    }
    if (r.runtimeHostInstancePresent === true) {
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-runtime-host";
    }
    if (r.activationHandlePresent === true) {
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-activation-handle";
    }
    if (
    ...
    if (
      ...
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-workspace-render";
    }
    if (
      (typeof r.shellChildCount === "number" && r.shellChildCount !== 0) ||
      (typeof r.shellDOMNodeCount === "number" && r.shellDOMNodeCount !== 0)
    ) {
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-shell";
    }
    if (
      ...
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-second-geofeed";
    }
    if (
      ...
      return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-runtime-mutation";
    }
  }

  if (input.owner !== undefined && input.owner !== "legacy") {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-ownership";
  }
  if (input.writer !== undefined && input.writer !== "legacy") {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-writer";
  }
  if (input.renderer !== undefined && input.renderer !== "legacy") {
    return "controlled-workspace-host-activation-issuance-pipeline-execution-blocked-renderer";
  }
  if (
...
export function createControlledWorkspaceHostActivationIssuancePipelineExecutionDescriptor(): ControlledWorkspaceHostActivationIssuancePipelineExecutionDescriptor {
  const record = createCommitRecord();
  return validateControlledWorkspaceHostActivationIssuancePipelineExecutionDescriptor(
    {
      schemaVersion:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_SCHEMA_VERSION,
      phase: "3B.3.41",
      previousPhase: "3B.3.40",
      currentPhase: "3B.3.41",
      ...
      activationBlocker:
        PHASE_3B3_41_CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ONLY,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONDITIONS,
      satisfiedConditions:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONDITIONS,
      unsatisfiedConditions: [],
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_GUARDS,
      satisfiedGuards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_GUARDS,
      unsatisfiedGuards: [],
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_BLOCKERS,
      browserInvariantIds: FEED_SEALED_INVARIANT_IDS,
    },
  );
}

export function validateControlledWorkspaceHostActivationIssuancePipelineExecutionDescriptor(
  d: ControlledWorkspaceHostActivationIssuancePipelineExecutionDescriptor,
): ControlledWorkspaceHostActivationIssuancePipelineExecutionDescriptor {
  if (
    d.phase !== "3B.3.41" ||
    d.previousPhase !== "3B.3.40" ||
    d.currentPhase !== "3B.3.41" ||
    d.nextEligibleStep !== "3B.3.42"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_PHASE",
      "Phase chain must be 3B.3.40 → 3B.3.41 → 3B.3.42",
    );
  }
  if (
    d.pipelineExecutionState !== "PIPELINE_EXECUTED_NOT_ACTIVATED" ||
    d.pipelineExecutionResult !==
      "controlled-workspace-host-activation-issuance-pipeline-executed-not-activated"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_RESULT",
      "Successful commit authorization must be PIPELINE_EXECUTED_NOT_ACTIVATED",
    );
  }
  if (
    ...
    d.activationIssuancePipelineExecutionAuthorizationId !==
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_AUTHORIZATION_ID ||
    d.activationIssuancePipelineExecutionId !==
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ID
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_IDENTITY",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_FLAGS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_COUNTS",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_PROGRESSION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_TRANSITION",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_PREDECESSOR",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_RUNTIME",
...
export function evaluateControlledWorkspaceHostActivationIssuancePipelineExecution(
  registry: ControlledHostRegistry = createControlledHostRegistry(),
  input?: ControlledWorkspaceHostActivationIssuancePipelineExecutionInput,
): ControlledWorkspaceHostActivationIssuancePipelineExecutionEvaluation {
  if (registry.hostCount !== 1) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_REGISTRY",
      "Issuance pipeline execution requires exactly one controlled-host registry entry",
    );
  }

  const predecessor = evaluatePredecessorPipelineExecutionAuthorization(registry);
  const pred = predecessor.descriptor;

  if (
    pred.pipelineExecutionAuthorizationResult !==
      "controlled-workspace-host-activation-issuance-pipeline-execution-authorized-not-executed" ||
    pred.pipelineExecutionAuthorizationState !== "PIPELINE_EXECUTION_AUTHORIZED_NOT_EXECUTED" ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_PREDECESSOR_LIVE",
      "Predecessor pipeline-execution-authorization must remain AUTHORIZED_NOT_EXECUTED with transaction OPENED prepared committed and NON_EXECUTABLE pipeline",
    );
  }
  ...
  if (blocked) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_BLOCKED",
      blocked,
    );
  }
  ...
  return {
    ...
    diagnostics: {
      ...
      activationTransactionOpeningAllowed: false,
      activationExecutionAllowed: false,
      pipelineExecutionResult: descriptor.pipelineExecutionResult,
      pipelineExecutionState: descriptor.pipelineExecutionState,
      ...
      blockerCount:
        CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_BLOCKERS.length,
      conditions: CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_CONDITIONS,
      guards: CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_GUARDS,
      blockers: CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_BLOCKERS,
