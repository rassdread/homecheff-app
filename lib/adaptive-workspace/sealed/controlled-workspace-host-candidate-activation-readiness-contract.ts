/**
 * Phase 3B.3.42 — Controlled Workspace Host Candidate Activation Readiness Contract.
 */
...
export const CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_SCHEMA_VERSION =
  1 as const;

export type ControlledWorkspaceHostCandidateActivationReadinessContract = {
  schemaVersion: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_SCHEMA_VERSION;
  phase: "3B.3.42";
  ...
  contractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_ID;
  ...
  activationRestriction: typeof PHASE_3B3_42_CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_ONLY;
  nextEligibleStep: "3B.3.43";
};

export function createControlledWorkspaceHostCandidateActivationReadinessContract(): ControlledWorkspaceHostCandidateActivationReadinessContract {
  return validateControlledWorkspaceHostCandidateActivationReadinessContract({
    schemaVersion:
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_SCHEMA_VERSION,
    phase: "3B.3.42",
    previousPhase: "3B.3.41",
    widgetId: "feed.discovery",
    ...
    activationTransactionCommitId:
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_TRANSACTION_COMMIT_ID,
    contractId: CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_ID,
...
export function validateControlledWorkspaceHostCandidateActivationReadinessContract(
  candidate: unknown,
): ControlledWorkspaceHostCandidateActivationReadinessContract {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_INVALID",
      "Transaction commit contract must be a plain object",
    );
  }
  const c = candidate as ControlledWorkspaceHostCandidateActivationReadinessContract;
  if (
    c.phase !== "3B.3.42" ||
    c.previousPhase !== "3B.3.41" ||
    c.nextEligibleStep !== "3B.3.43"
  ) {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_PHASE",
      "phase must be 3B.3.42 with previousPhase 3B.3.41",
    );
  }
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_READINESS_CONTRACT_FLAGS",
