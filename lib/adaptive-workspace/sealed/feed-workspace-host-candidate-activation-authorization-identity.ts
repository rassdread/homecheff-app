/**
 * Phase 3B.3.43 — Workspace host activation candidate-activation-authorization identity contract.
 */
...
export const FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_IDENTITY_SCHEMA_VERSION =
  1 as const;

export type FeedWorkspaceHostCandidateActivationAuthorizationIdentity = {
  schemaVersion: typeof FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_IDENTITY_SCHEMA_VERSION;
  phase: "3B.3.43";
  ...
  activationCandidateActivationAuthorizationId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ID;
  activationCandidateActivationAuthorizationContractId: typeof CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_CONTRACT_ID;
...
export function createFeedWorkspaceHostCandidateActivationAuthorizationIdentity(): FeedWorkspaceHostCandidateActivationAuthorizationIdentity {
  return validateFeedWorkspaceHostCandidateActivationAuthorizationIdentity({
    schemaVersion:
      FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_IDENTITY_SCHEMA_VERSION,
    phase: "3B.3.43",
...
export function validateFeedWorkspaceHostCandidateActivationAuthorizationIdentity(
  candidate: unknown,
): FeedWorkspaceHostCandidateActivationAuthorizationIdentity {
  if (candidate === null || typeof candidate !== "object") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_IDENTITY_INVALID",
      "Commit-readiness identity must be a plain object",
    );
  }
  const c = candidate as FeedWorkspaceHostCandidateActivationAuthorizationIdentity;
  if (c.phase !== "3B.3.43") {
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_IDENTITY_PHASE",
      "phase must be 3B.3.43",
    );
  }
  if (
    ...
    c.activationIssuancePipelineExecutionId !==
      CONTROLLED_WORKSPACE_HOST_ACTIVATION_ISSUANCE_PIPELINE_EXECUTION_ID ||
    c.activationCandidateActivationAuthorizationId !==
      CONTROLLED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_ID ||
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_IDENTITY_CHAIN",
  ...
  if (
    ...
    throw new HardContractViolation(
      "FEED_WORKSPACE_HOST_CANDIDATE_ACTIVATION_AUTHORIZATION_IDENTITY_TRANSFER",
