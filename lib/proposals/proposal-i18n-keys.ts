...
export const PROPOSAL_I18N = {
  ...
  buyerOffers: 'proposal.card.buyerOffers',
  youOffer: 'proposal.card.youOffer',
  youAskConsideration: 'proposal.card.youAskConsideration',
  sellerAsks: 'proposal.card.sellerAsks',
  buyerDelivers: 'proposal.card.buyerDelivers',
  sellerDelivers: 'proposal.card.sellerDelivers',
  inExchangeFor: 'proposal.card.inExchangeFor',
  acceptedAlternatives: 'proposal.card.acceptedAlternatives',
  buyerConsiderationPhotos: 'proposal.card.buyerConsiderationPhotos',
  yourConsiderationPhotos: 'proposal.card.yourConsiderationPhotos',
