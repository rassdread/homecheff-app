    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          <p className="text-sm text-gray-500 mt-2">12% HomeCheff fee</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          <p className="text-sm text-gray-600">Wordt automatisch uitbetaald binnen 2-5 werkdagen</p>
        </div>
            ...
            <tbody className="divide-y">
              {payouts.map((payout) => (
                <tr key={payout.id} className="hover:bg-gray-50">
                  <td className="px-4 py-3 text-sm">{payout.transaction.productTitle || 'N/A'}</td>
                  <td className="px-4 py-3 text-sm">
