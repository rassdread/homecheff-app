    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Overzicht en beheer van alle bestellingen</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Ordernummer, naam, email..."
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600">Geen orders gevonden</p>
          </div>
        ) : (
          ...
          {loadingDetails ? (
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700">Totaal Bedrag</label>
