          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Zoek in producten, gerechten, makers..."
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="rating">Hoogste rating eerst</option>
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm text-gray-700">Alleen geverifieerde verkopers</span>
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      ...
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm text-gray-700">Alleen met reviews</span>
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
