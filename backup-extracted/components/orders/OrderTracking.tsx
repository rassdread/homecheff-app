...
export default function OrderTracking({ orderId }: OrderTrackingProps) {
  ...
  const handleWriteReview = () => {
    // Navigate to review page for this order
    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="p-6">
            ...
            {order.items?.map((item: any) => (
              <div key={item.id} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-medium text-gray-900 text-sm sm:text-base truncate">{item.product?.title}</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Aantal: {item.quantity}</p>
                </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          <button className="flex items-center justify-center gap-2 px-4 py-3 sm:py-2 bg-primary-brand text-white rounded-lg hover:bg-primary-700 transition-colors font-medium">
          ...
          {order.status === 'DELIVERED' && (
            <button 
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 sm:py-2 bg-emerald-100 text-emerald-700 rounded-lg hover:bg-emerald-200 transition-colors font-medium"
            >
