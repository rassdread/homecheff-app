...
export default function QuickAddHandler({ 
  ...
  const [step, setStep] = useState<'camera' | 'form'>(photo ? 'form' : 'camera');
        ...
        <div className="absolute top-0 left-0 right-0 z-10 bg-gradient-to-b from-black/50 to-transparent p-4">
          <div className="flex items-center justify-between text-white">
            ...
            <button
              ...
              className="p-2 hover:bg-white/20 rounded-full transition-colors"
              title="Overslaan naar formulier"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="min-h-full">
          ...
          <div className="p-4">
            ...
            <div className="mt-4 p-2 bg-gray-100 rounded text-xs text-gray-600">
              Debug: platform={platform}, category={category}, location={location}, photo={capturedPhoto ? 'yes' : 'no'}
            </div>
          </div>
        </div>
      </div>
