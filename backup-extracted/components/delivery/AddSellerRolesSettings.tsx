...
export default function AddSellerRolesSettings({ currentRoles, age, onSave }: AddSellerRolesSettingsProps) {
  ...
  const handleSave = async () => {
    if ((requiresPrivacy && !agreements.privacyPolicy) ||
        ...
        (requiresTax && !agreements.taxResponsibility) ||
        (requiresParental && !agreements.parentalConsent)) {
      alert('Je moet alle vereiste voorwaarden accepteren');
      return;
    }
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-900">Vereiste Akkoorden</h3>
            </div>
            ...
            <div className="flex items-center gap-3">
              {allAgreed ? (
                ...
                <>
                  ...
                  <div>
                    <p className="font-bold text-orange-900">Vereiste akkoorden ontbreken</p>
                    <p className="text-sm text-orange-700">
                      Accepteer alle vereiste voorwaarden (gemarkeerd met <span className="text-red-500">*</span>)
                    </p>
                  </div>
                </>
              )}
