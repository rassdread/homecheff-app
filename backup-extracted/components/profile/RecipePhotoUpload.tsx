...
export default function RecipePhotoUpload({ 
  ...
  const handleCameraCapture = async (photoUrl: string) => {
    ...
    // TODO: Fix camera upload
    console.log('Camera photo captured:', file);
  };
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <label 
            ...
            className={`cursor-pointer inline-flex items-center px-3 py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors ${
          ...
          >
            {uploading ? (
              ...
              <>
                ...
                {dragActive ? 'Laat los om te uploaden' : 'Bestanden'}
              </>
            )}
          </label>
