  ...
  home: {
    ...
    tourSteps: [
      ...
      },
      {
        ...
        title: '📦 Producten kopen of op het plein zetten',
        description: 'Hier ontdek je wat je kunt kopen: prijs, maker en bezorging. Ben jij zelf maker? Zet je creaties op het dorpsplein te koop en bereik je buurt direct vanuit je HomeCheff-profiel.',
        placement: 'top',
