...
function LoginForm() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Force session refresh and redirect naar inspiratie (nieuwe startpagina)
      window.location.href = '/inspiratie?welcome=true';
    } catch (error) {
      setState({ 
        ...state, 
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            ...
            <div className="mt-6 space-y-3">
              <button
                ...
                disabled={state.isLoading}
                className="w-full inline-flex justify-center items-center px-6 py-4 border-2 border-gray-200 rounded-2xl shadow-sm bg-white text-base font-semibold text-gray-800 hover:border-emerald-300 hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 group"
              >
                ...
                <span className="group-hover:text-emerald-700 transition-colors duration-200">Inloggen met Google</span>
              </button>

              <button
                onClick={() => handleSocialLogin("facebook")}
                disabled={state.isLoading}
                className="w-full inline-flex justify-center items-center px-6 py-4 border-2 border-gray-200 rounded-2xl shadow-sm bg-white text-base font-semibold text-gray-800 hover:border-blue-300 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 group"
              >
                ...
                <span className="group-hover:text-blue-700 transition-colors duration-200">Inloggen met Facebook</span>
              </button>
            </div>
          </div>
