      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(() => {
          ...
          return newOrders.length > 0 && (
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm border border-blue-200 mb-8 p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900">Nieuwe Verkooporders</h2>
                    <p className="text-sm text-gray-600">
                      {newOrders.length} {newOrders.length === 1 ? 'nieuwe bestelling' : 'nieuwe bestellingen'}
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {newOrders.slice(0, 3).map((order) => (
                  <div 
                    key={order.id}
                    onClick={() => router.push('/verkoper/orders')}
                    className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-blue-100"
                  >
              ...
              {newOrders.length > 3 && (
                <div className="mt-4 text-center">
                  ...
                  >
                    +{newOrders.length - 3} meer nieuwe bestellingen bekijken →
                  </button>
                </div>
              )}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-sm">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-gray-900">Alle Verkooporders</h3>
                <button
                  onClick={() => router.push('/verkoper/orders')}
                  className="text-blue-600 hover:text-blue-700 text-sm font-medium"
                >
            ...
            <div className="p-6">
              {recentOrders.length > 0 ? (
                <div className="space-y-4">
                  {recentOrders.map((order) => (
                    <div 
                      key={order.id} 
                      onClick={() => router.push('/verkoper/orders')}
                      className="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 cursor-pointer transition-colors rounded-lg px-2 -mx-2"
                    >
                      <div className="flex-1">
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">Nog geen verkooporders</p>
                  <button
                    onClick={() => router.push('/verkoper/orders')}
                    className="mt-4 text-blue-600 hover:text-blue-700 text-sm font-medium"
                  >
                    Verkooporders beheren
                  </button>
                </div>
              )}
            </div>
