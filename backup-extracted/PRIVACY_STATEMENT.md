...
### 8.4 Lokale sessie-opslag (browser):
- **Winkelwagen (`homecheff_cart_<id>` in localStorage):** 30 minuten inactiviteit, gekoppeld aan ingelogde gebruiker of anonieme sessie-ID. Wordt automatisch geleegd bij expliciet uitloggen of na vervaldatum.
- **Checkout-concept (`homecheff_checkout_draft_<id>` in sessionStorage):** 12 uur voor adres- en bezorgvoorkeuren. Verwijdert zichzelf na succesvolle bestelling, leeg winkelmandje of handmatige verwijdering van de gebruiker.
- **Registratie-concept (`homecheff_register_draft_v1` in sessionStorage):** 48 uur voor meerstaps-aanmelding. Gebruiker kan dit concept wissen via de knop “Concept wissen” binnen het registratieproces; het wordt automatisch verwijderd na succesvolle registratie of bij sessie-einde.
- **Doel:** Continuïteit van gebruikerssessies en het voorkomen van gegevensverlies bij netwerkonderbrekingen of browserverversingen.
- **Gebruikerscontrole:** In-app knoppen voor het legen van het winkelmandje en het wissen van concepten; daarnaast kan de gebruiker altijd lokale opslag wissen via browserinstellingen.
...
### 9.4 Beperking van verwerking (Art. 18 AVG):
