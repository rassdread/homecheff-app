  ...
  return (
    <div className="max-w-2xl mx-auto p-4 bg-white rounded-lg shadow-sm" data-compact-chef-form>
      ...
      <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              {orderMethod === 'CONTACT'
                ...
                : t('compactForms.shared.priceLabel')}
            </label>
            {orderMethod === 'CONTACT' ? (
              <p className="text-xs text-gray-500 mb-1.5 leading-snug">
            ...
            <input
              ...
              placeholder={
                orderMethod === 'CONTACT'
                  ...
                  : t('compactForms.shared.pricePlaceholderChef')
              }
              inputMode="decimal"
            />
          </div>
        ...
        <div className="sticky bottom-0 z-10 -mx-4 -mb-4 mt-4 flex gap-2 border-t border-gray-200 bg-white p-4 max-lg:pb-[calc(env(safe-area-inset-bottom,0px)+5.75rem)] lg:pb-4 shadow-lg">
          <button
            type="submit"
            disabled={submitting}
