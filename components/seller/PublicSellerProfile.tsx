...
export default function PublicSellerProfile({ sellerProfile, isOwner = false }: PublicSellerProfileProps) {
  ...
  // Calculate average rating from reviews (flatten from products)
  const reviews: any[] = (sellerProfile as any).reviews || [];
                          ...
                          <div key={review.id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                            <div className="flex gap-4">
                              ...
                              {review.product?.Image?.[0] && (
                                <div className="flex-shrink-0">
                                  <img
                                    src={review.product.Image[0].fileUrl || review.product.Image[0].url}
                              ...
                              <div className="flex-1">
                                {/* Product Title */}
                                <div className="mb-2">
                                  <h4 className="font-semibold text-gray-900">{review.product?.title || 'Product'}</h4>
                                </div>
