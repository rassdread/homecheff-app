    ...
    <div ref={rootRef} className={`relative ${className}`}>
      ...
      {open ? (
        <div
          ...
          className="absolute right-0 z-[80] mt-2 w-[min(20rem,calc(100vw-1.5rem))] rounded-xl border border-gray-200 bg-white p-3 shadow-lg"
        >
          <div className="mb-2 flex items-start gap-2 border-b border-gray-100 pb-2">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] leading-snug text-gray-500">{ECOSYSTEM_PANEL_SUPPORT}</p>
            </div>
          </div>
