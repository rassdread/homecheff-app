...
type LanguageSwitcherProps = {
  /** Header utility: flag + chevron only, so it never competes with the primary CTA. */
  compact?: boolean;
};
  ...
  return (
    <div className="relative z-[100]" ref={dropdownRef}>
      <button
        ...
        className={
          compact
            ? 'flex items-center gap-1 px-2 py-2 text-gray-600 hover:text-primary-brand transition-colors rounded-lg hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-brand'
            : 'flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2 text-gray-700 hover:text-primary-brand transition-colors rounded-lg hover:bg-gray-50'
        }
      ...
      >
        {compact ? null : <Globe className="w-4 h-4 flex-shrink-0" />}
