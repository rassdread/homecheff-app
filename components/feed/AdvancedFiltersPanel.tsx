      ...
      {isOpen && (
        <div className="p-4 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {/* Sort By */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">{t('filters.sort')}</label>
              <select
              ...
              >
                {searchType === 'products' ? (
                  <>
                    ...
                    <option value="distance">{t('filters.sortDistanceFirst')}{!userLocation ? ` (${t('filters.locationNeeded')})` : ''}</option>
                  </>
                ) : (
                  <>
                    <option value="name">{t('filters.sortNameAZ')}</option>
                    <option value="followers">{t('filters.sortMostFollowers')}</option>
                    <option value="products">{t('filters.sortMostProducts')}</option>
                    <option value="distance">{t('filters.sortDistanceFirst')}{!userLocation ? ` (${t('filters.locationNeeded')})` : ''}</option>
                  </>
                )}
              </select>
