...
export function DorpspleinPageContent({ layout = 'page' }: { layout?: 'page' | 'hub' } = {}) {
  ...
  const shellClass =
    layout === 'hub' ? 'min-h-0 bg-neutral-50' : 'min-h-screen bg-neutral-50';
  ...
  return createElement(
    ...
    <>
      ...
      {/* Hero Section (alleen eigen dorpsplein-route; in ontdek-hub staat één gedeelde hero) */}
      {layout === 'page' && translationsReady && (
      ...
      {layout === 'page' && translationsReady && pageHints && pageHints.tourSteps && pageHints.tourSteps.length > 0 && (
