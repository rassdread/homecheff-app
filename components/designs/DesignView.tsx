...
export default function DesignView({ design, isOwner, ownerPermissions, currentUser }: DesignViewProps) {
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <button
                ...
                title={isAffiliate ? "Deel dit design - je affiliate link wordt automatisch meegestuurd" : t('common.share')}
              >
              ...
              {!isOwner && (
                <StartChatButton
                  ...
                  sellerName={getDisplayName(design.user)}
                  productId={design.id}
        ...
        <div id="printable-design" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 print:py-4">
                ...
                <div className="flex items-center justify-center space-x-3">
                  ...
                  {design.user.profileImage ? (
                    <Image
                      ...
                      alt={getDisplayName(design.user)}
                      width={40}
                      height={40}
          ...
          {/* Video */}
          {design.video && design.video.url && (
            <div className="artisan-frame bg-white rounded-none sm:rounded-2xl shadow-xl overflow-hidden mb-6 print:mb-4 print-avoid-break border-3 border-yellow-700 relative no-print">
              <div className="artisan-corner artisan-corner-tl"></div>
              <div className="artisan-corner artisan-corner-tr"></div>
              <div className="artisan-corner artisan-corner-bl"></div>
              <div className="artisan-corner artisan-corner-br"></div>
