            ...
            {photos.map((photo, index) => (
              ...
              >
                ...
                {!photo.isMain && (
                  <button
                    type="button"
                    className="absolute bottom-1 left-1 bg-yellow-600 text-white text-xs px-2 py-1 rounded hover:bg-yellow-700 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity"
