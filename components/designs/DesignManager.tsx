...
export default function DesignManager({ isActive = true, userId, isPublic = false, hideAddButton = false, autoOpenForm = false }: DesignManagerProps) {
  ...
  useInspiratieFormOpener({
    isActive,
    expectedLocation: 'atelier',
    componentName: 'DesignManager',
    setShowForm,
    setFormData
  });
  ...
  useEffect(() => {
    ...
    const handleFocusIn = (e: FocusEvent) => {
      ...
      if ((target.tagName === 'INPUT' || target.tagName === 'TEXTAREA' || target.tagName === 'SELECT') && window.innerWidth < 768) {
        ...
        setTimeout(() => {
          ...
          const scrollContainer = document.querySelector('[data-design-form]') as HTMLElement;
    ...
    const formContainer = document.querySelector('[data-design-form]');
    if (formContainer) {
  ...
  useEffect(() => {
    if (showForm) {
      console.log('=== DesignManager: Form opened, checking for photo ===');
      ...
      const mainPhotos = formData.photos;
      ...
      if (inspiratiePhoto && (mainPhotos.length === 0 || (!formData.video && isVideo))) {
        ...
        const retry = setInterval(() => {
          ...
          if (photo && (formData.photos.length === 0 || (!formData.video && isVideo))) {
            if (isVideo) {
  ...
  const handleDeleteDesign = async (designId: string) => {
    if (!confirm(t('errors.confirmDeleteDesign'))) return;
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1">
          <input
            type="text"
            placeholder={t('common.searchInDesigns')}
            value={searchQuery}
            ...
            <div className="min-h-full flex items-start sm:items-center justify-center p-0 sm:p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-base touch-manipulation ${
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-base touch-manipulation resize-none"
                  placeholder={t('common.tellAboutCreation')}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-base touch-manipulation"
                  placeholder={t('common.exampleDimensions')}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-base touch-manipulation resize-none"
                  placeholder={t('common.personalNotesDesign')}
                />
              </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        title={t('common.putDesignForSale')}
                      >
