  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        title={t('common.messagesAndNotifications')}
      >
            ...
            <div className="flex gap-2 mb-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder={t('common.searchInMessages')}
              ...
              >
                ...
                <option value="conversations">{t('messages.conversations')}</option>
                <option value="notifications">{t('common.notifications')}</option>
              </select>
            </div>
          </div>
            ...
            {loading ? (
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-gray-400 text-xs mt-1">
                  {searchQuery ? t('common.tryOtherSearchTerms') : t('messages.noMessagesReceived')}
                </p>
              </div>
