...
export default function AnalyticsDashboard() {
  ...
  if (!analyticsData) {
    return (
      <div className="text-center py-12 bg-white rounded-xl shadow-sm border">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Geen analytics data beschikbaar</h3>
        <p className="text-gray-500 mb-4">Er is een fout opgetreden bij het ophalen van de gegevens</p>
        <button
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          <div className="space-y-3">
            {analyticsData.topCities && analyticsData.topCities.length > 0 ? analyticsData.topCities.slice(0, 5).map((city, index) => (
              ...
              <p className="text-sm text-gray-500 text-center py-4">Nog geen data beschikbaar</p>
            )}
          </div>
        </div>
      ...
      {/* Top Products Detail */}
      <div className="bg-white rounded-xl shadow-sm border p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-6">Top Producten - Gedetailleerd</h3>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b">
              <tr>
                ...
                <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Weergaven</th>
                <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Verkocht</th>
                <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Favorieten</th>
                <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Conversie</th>
                <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Omzet</th>
              </tr>
            </thead>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-xs opacity-70 mt-2">Laatste {timeRange}</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-3xl font-bold mb-1">Conversie Rate</p>
          <p className="text-sm opacity-90">Views → Verkopen</p>
          <p className="text-xs opacity-70 mt-2">
            {formatNumber(analyticsData.totalViews)} views → {formatNumber(analyticsData.totalOrders)} orders
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-90">Meest bekeken product</p>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-90">Best verkocht</p>
          <p className="text-xs opacity-70 mt-2 truncate">
            {analyticsData.topProducts && analyticsData.topProducts.length > 0 
