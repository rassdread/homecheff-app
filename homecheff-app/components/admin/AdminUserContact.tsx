  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Zoek gebruikers en bekijk hun contactinformatie (admin only)</p>
      </div>
        ...
        <div className="flex gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              placeholder="Zoek op naam, username, email, telefoonnummer..."
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              {selectedUser.address || selectedUser.city ? (
                ...
                <p className="text-gray-500 italic">Geen adresgegevens beschikbaar</p>
              )}
