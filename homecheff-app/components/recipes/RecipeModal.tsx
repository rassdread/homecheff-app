...
Recept gedeeld via HomeCheff
  ...
  console.log('Full recipe photos:', fullRecipe.photos);
  ...
  console.log('Main photos:', mainPhotos);
  console.log('Step photos:', stepPhotos);
  
  // Debug: Check if photos have valid URLs
  mainPhotos.forEach((photo, index) => {
    console.log(`Main photo ${index}:`, { url: photo.url, isMain: photo.isMain, stepNumber: photo.stepNumber });
  });
  stepPhotos.forEach((photo, index) => {
    console.log(`Step photo ${index}:`, { url: photo.url, stepNumber: photo.stepNumber });
  });
                    ...
                    {displayPhotos.length > 0 && displayPhotos[currentPhotoIndex]?.url ? (
                      <>
                        <img
                          ...
                          onLoad={() => {
                            console.log('Image loaded successfully:', displayPhotos[currentPhotoIndex].url);
                          }}
                        />
                      ...
                      <>
                        <img
                          ...
                          onLoad={() => {
                            console.log('Image loaded successfully:', fullRecipe.photos[currentPhotoIndex].url);
                          }}
                        />
