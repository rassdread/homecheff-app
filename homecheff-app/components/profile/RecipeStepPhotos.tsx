          ...
          <div key={stepNumber} className="bg-gray-50 rounded-lg p-4">
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 line-clamp-2">{step}</p>
              </div>
            ...
            {stepPhotos.length > 0 && (
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-3">
                {stepPhotos.map((photo) => (
                  <div
                    key={photo.id}
                    className="relative group aspect-square bg-white rounded-lg overflow-hidden border border-gray-200"
                  >
                    <img
                      src={photo.url}
