      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h3 className="text-lg font-semibold text-primary-brand mb-2">
            Jongeren Bezorgen (15+)
          </h3>
          <p className="text-gray-700 mb-4">
            Jongeren vanaf 15 jaar bezorgen je bestelling tegen een kleine vergoeding. 
            Dit is wettelijk toegestaan en ondersteunt de lokale gemeenschap en jongerenwerk.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              <Shield className="w-4 h-4 text-green-600" />
              <span>Wettelijk toegestaan (15+)</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-gray-600">
              <Heart className="w-4 h-4 text-red-600" />
              <span>Ondersteunt jongerenwerk</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-gray-600">
