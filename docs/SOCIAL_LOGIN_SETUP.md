...
> ℹ️ **Tip:** Laat `https://homecheff-app.vercel.app` ook als extra redirect URL staan in Google Cloud en Facebook, zodat preview deployments blijven werken. Voeg daarnaast zowel `https://homecheff.nl` als `https://www.homecheff.nl` toe aan de toegestane domeinen in Google en Facebook.
...
4. **Je wordt doorgestuurd naar:** `/register?social=true`
