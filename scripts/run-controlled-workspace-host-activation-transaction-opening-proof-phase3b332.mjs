...
async function main() {
  ...
  if (prior.overallVerdict !== "READY_FOR_PHASE_3B_3_32") {
    throw new Error(`Phase 3B.3.31 proof required: ${prior.overallVerdict}`);
  }

  if (process.env.SKIP_BUILD !== "1") {
    console.log("[phase3b332] production build NEXT_PUBLIC_FEED_SEALED_BASELINE=1");
  ...
  try {
    ...
    console.log("[phase3b332] Phase 3B.2 proof rerun");
    await run("node", [
