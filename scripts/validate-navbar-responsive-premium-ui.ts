...
assert(nav.includes('hidden xl:flex'), 'desktop nav xl+ only');
assert(nav.includes('xl:hidden'), 'hamburger below xl');
assert(nav.includes('xl:px-4 xl:py-2.5 xl:text-sm'), 'premium nav sizing from xl');
